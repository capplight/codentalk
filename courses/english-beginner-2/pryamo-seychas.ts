  ...
  lessons: [
    {
       ...
       * З3; `I am learning English now.` — ответ З4.
       *
       * СЛУЧАЙ 7 ПЕРЕДЕЛАН РЕШЕНИЕМ МЕТОДИСТА 16.6: он печатал
       * `I am learning English.` — ту же строку, что ответ З4 без now. Теперь там
       * `I am studying at a college.` и `I am playing football.`, а задание З4 и образец
       * З5 остались прежними: устный образец стоит ПОСЛЕ задания и его ответом не является.
       */
      slug: "ya-chitayu",
      ...
      blocks: [
        {
          ...
          explain:
            "Сначала Ким здоровается, потом называет место, а в конце говорит, что делает " +
            "сейчас. После I у него стоит am, а за ним глагол с окончанием -ing.",
        },
        {
          ...
          znak: "1f4d6",
          text: [
            "Строка о том, что я делаю сейчас",
            "Сначала в строке стоит I, потом am, а потом глагол с окончанием -ing. Такая " +
              "строка говорит о том, что человек делает прямо сейчас.",
        ...
        },
        {
          ...
          znak: "1f9e9",
          text: [
            "Три части такой строки",
            "Такая строка состоит из трёх частей. Первой стоит I, за ней am, а за ним глагол " +
              "с окончанием -ing. Это время называется Present Continuous.",
            "I am eating. — Я ем.",
            "I am drinking tea. — Я пью чай.",
          ],
        ...
        },
        {
          ...
          znak: "1f4cd",
          text: [
            "Где я и что я там делаю",
            "Модуль «Откуда ты и где живёшь» учит говорить, где человек сейчас. Рядом с такой " +
              "строкой встаёт вторая, и она говорит, что человек там делает.",
            "I am in the kitchen. I am cooking. — Я на кухне. Я готовлю.",
            "I am at work. I am working. — Я на работе. Я работаю.",
          ],
        ...
        },
        {
          ...
          text: [
            "Кто я и что я делаю сейчас",
            "Строка с названием занятия говорит, кто человек, и такие строки разобрал модуль " +
              "«Что я делаю каждый день». А строка с глаголом на -ing говорит, что человек " +
              "делает прямо сейчас.",
            "I am a student. I am studying. — Я студент. Я занимаюсь.",
            "I am a cook. I am cooking. — Я повар. Я готовлю.",
          ],
        ...
        },
        {
          ...
          znak: "26bd",
          text: [
            "Любой глагол получает такое же окончание",
            "Так же собирают строку с любым глаголом из модуля «Что я делаю каждый день». " +
              "Глагол получает окончание -ing, а перед ним остаются I и am.",
            "I am studying at a college. — Я занимаюсь в колледже.",
            "I am playing football. — Я играю в футбол.",
          ],
          zvuchat: ["I am studying at a college.", "I am playing football."],
        },
        {
          /*
          ...
          znak: "26a0",
          text:
            "Окончание -ing после формы be\n\nСтрока о том, что человек делает обычно, " +
            "обходится одним глаголом. Так было в модуле «Что я делаю каждый день», так " +
            "остаётся и теперь. Глагол без изменений после am не ставят. А если после am стоит " +
            "глагол, у него есть окончание -ing.\n\nЗапись I am drink tea. сделана с ошибкой, " +
            "потому что у глагола нет окончания -ing. В записи I drinking tea. ошибка другая, " +
            "потому что в ней потеряно am. Верной будет строка I am drinking tea.",
        ...
        },
        {
          ...
          kind: "choice",
          prompt:
            "Ким пишет Дане, что он сейчас пьёт сок. Отметь строку без ошибки.",
          options: [
            { text: "I am drink juice." },
            { text: "I am drinking juice.", correct: true },
            { text: "I drinking juice." },
          ],
          hint: "Посмотри в каждой строке, что стоит после I и чем заканчивается глагол.",
          why:
            "Верна строка I am drinking juice. В записи I am drink juice. у глагола нет " +
