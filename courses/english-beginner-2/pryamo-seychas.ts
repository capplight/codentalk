...
const modul: Module = {
  ...
  lessons: [
      ...
      blocks: [
        ...
        },
        {
          ...
          text: [
            ...
            "ПИШЕТ РЕДАКТОР: правило одной строкой. I am пишут и коротко, как в модуле «Здравствуйте, меня зовут».",
        ...
        },
        {
          ...
          text: [
            ...
            "ПИШЕТ РЕДАКТОР: правило одной строкой. now значит «сейчас». В этих строках оно " +
              "стоит в конце, а в уроке «Каждый день и сейчас» оно стоит и в начале.",
        ...
        },
        {
          ...
          text: [
            ...
            "ПИШЕТ РЕДАКТОР: правило одной строкой. Модуль «Откуда ты и где живёшь» учит говорить, где человек сейчас; " +
        ...
        },
        {
          ...
          text: [
            ...
            "ПИШЕТ РЕДАКТОР: правило одной строкой. Строка с названием говорит, кто человек " +
              "из модуля «Что я делаю каждый день»; строка с -ing — что он делает сейчас.",
        ...
        },
        {
          ...
          text: [
            ...
            "ПИШЕТ РЕДАКТОР: правило одной строкой. Любой глагол модуля «Что я делаю каждый день» получает -ing так же.",
        ...
        },
        {
          ...
          znak: "26a0",
          text:
            "ПИШЕТ РЕДАКТОР: врезка «Раньше было I am drink». Мост к модулю «Что я делаю " +
            "каждый день» ЕГО ЖЕ СЛОВАМИ после правки редактора. Там строка о том, что " +
            "человек делает обычно, обходилась одним глаголом. После am глагол без изменений " +
            "там не ставили. Строка о том, что делаешь сейчас, стоит на форме be и глаголе " +
            "с окончанием -ing. Если после am стоит глагол, у него окончание -ing. Вторая ошибка " +
            "— потерять am. Так нельзя: I am drink tea. и I drinking tea. Верно: I am drinking tea.",
        ...
        },
        {
          ...
          hint: "ПИШЕТ РЕДАКТОР: подсказка к З1, урок «Я читаю» — дорога, а не ответ.",
          why:
        ...
        },
        {
          ...
          answer: "walking",
          hint: "ПИШЕТ РЕДАКТОР: подсказка к З2, урок «Я читаю» — дорога, а не ответ.",
        ...
        },
        {
          ...
          answer: [2, 3, 0, 1],
          hint: "ПИШЕТ РЕДАКТОР: подсказка к З3, урок «Я читаю» — дорога, а не ответ.",
        ...
        },
        {
          ...
          hint: "ПИШЕТ РЕДАКТОР: подсказка к З4, урок «Я читаю» — дорога, а не ответ.",
          why:
        ...
        },
        {
          ...
          translation: "ПИШЕТ РЕДАКТОР: перевод образца о себе и своём месте.",
          hint: "ПИШЕТ РЕДАКТОР: подсказка к З5, урок «Я читаю» — дорога, а не ответ.",
          why:
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            {
              term: "talk",
              translation: "ПИШЕТ РЕДАКТОР: перевод карточки talk.",
            ...
            {
              term: "clean",
              translation: "ПИШЕТ РЕДАКТОР: перевод карточки clean.",
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            {
              term: "sit",
              translation: "ПИШЕТ РЕДАКТОР: перевод карточки sit.",
              example:
                "ПИШЕТ РЕДАКТОР: ВОПРОС МЕТОДИСТУ — пример карточки sit замысел не назвал; в нём " +
                "нельзя форму sitting (ответ З4, урок «Как пишется»).",
              hint: "/sɪt/",
              znak: "1fa91",
            },
            {
              term: "run",
              translation: "ПИШЕТ РЕДАКТОР: перевод карточки run.",
            ...
            {
              term: "ride",
              translation: "ПИШЕТ РЕДАКТОР: перевод карточки ride.",
            ...
            {
              term: "bike",
              translation: "ПИШЕТ РЕДАКТОР: перевод карточки bike.",
              example:
                "ПИШЕТ РЕДАКТОР: ВОПРОС МЕТОДИСТУ — пример карточки bike замысел не назвал; " +
                "строка текста урока «Читаем: выходной у Айгерим» с bike служит ответом З1, урок «Читаем: выходной у Айгерим», а riding в модуле не " +
                "печатается.",
              hint: "/baɪk/",
              znak: "1f6b2",
            },
      ...
      blocks: [
        {
          ...
          head: ["Каждый день (Present Simple)", "Сейчас (Present Continuous)"],
          rows: [
            ["I work.", "I am working."],
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            {
              term: "wear",
              translation: "ПИШЕТ РЕДАКТОР: перевод карточки wear.",
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            {
              term: "aren't",
              translation: "ПИШЕТ РЕДАКТОР: перевод карточки aren't.",
              example: "We aren't dancing.",
              hint: "/ɑːnt/",
            },
            {
              term: "are not",
              translation: "ПИШЕТ РЕДАКТОР: перевод карточки are not.",
              example:
                "ПИШЕТ РЕДАКТОР: ВОПРОС МЕТОДИСТУ — пример карточки are not замысел не назвал; " +
                "строки с полной записью в уроке стоят только у is not (случай 4).",
              hint: "/ɑː nɒt/",
            },
          ],
        },
...

    {
      ...
      blocks: [
        ...
        },
        {
          ...
          kind: "short",
          prompt: "ПИШЕТ РЕДАКТОР: условие — обратись к Алиму на you и спроси, готовит ли он сейчас.",
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            {
              term: "draw",
              translation: "ПИШЕТ РЕДАКТОР: перевод карточки draw.",
...

    {
       ...
       *
       * ИМЯ УРОКА взято из раздела 7.9 замысла; таблица раздела 5 зовёт его
       * «Читаем: кто чем занят» — расхождение внутри замысла, вопрос методисту
       * (журнал сборки).
       *
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            {
              term: "wash",
              translation: "ПИШЕТ РЕДАКТОР: перевод карточки wash.",
              example:
                "ПИШЕТ РЕДАКТОР: ВОПРОС МЕТОДИСТУ — пример карточки wash замысел не назвал; " +
                "строка сообщения с wash служит ответом З1 этого урока, а запись вопроса 11 " +
                "работы — ответом работы.",
              hint: "/wɒʃ/",
              znak: "1f9fc",
            },
          ],
...

    {
       ...
       *
       * СЛОВАРЬ УРОКА СТОИТ ПОСЛЕ ЗАДАНИЙ: карточка `bird` печатает ответ З2, и
       * до задания ей стоять нельзя (журнал сборки, вопрос методисту).
       */
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            {
              term: "bird",
              translation: "ПИШЕТ РЕДАКТОР: перевод карточки; у методиста в столбце значка — «птица».",
              example:
                "ПИШЕТ РЕДАКТОР: ВОПРОС МЕТОДИСТУ — пример карточки bird замысел не назвал; " +
                "строка записи с bird служит ответом З2 этого урока.",
              hint: "/bɜːd/",
              znak: "1f426",
            },
          ],
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "ПИШЕТ РЕДАКТОР: подпись второй картинки — женщина готовит.",
            "ПИШЕТ РЕДАКТОР: подпись третьей картинки — кошка спит под столом.",
            "ПИШЕТ РЕДАКТОР: подпись четвёртой картинки — дети играют.",
          ],
        },
        {
        ...
        },
        {
          ...
          znak: "1f9d2",
          znakov: 2,
          prompt: "ПИШЕТ РЕДАКТОР: условие — подпись «дети играют»; отметь строку без ошибки.",
          options: [
