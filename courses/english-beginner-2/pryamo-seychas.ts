  ...
  lessons: [
...

    {
      ...
      vstuplenie:
        ...
        "По-английски в вопросе меняется порядок слов, и форма be выходит вперёд. Так же мы " +
        "строили вопрос в модуле «Откуда ты и где живёшь». Здесь мы разберём вопрос о том, что " +
        "человек делает сейчас, и короткий ответ на него.",
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "В вопросе к собеседнику форма are встаёт перед you.",
        ...
        },
        {
          ...
          text: [
            "Вопрос о нескольких",
            "Когда спрашиваем о нескольких людях, впереди встаёт are.",
        ...
        },
        {
          ...
          why:
            "Получается ответ Yes, they are. Родителей несколько, поэтому и в вопросе, и в " +
            "ответе стоит are.",
        },
        {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: [
            ...
            "По-русски мы спрашиваем «что ты делаешь?». По-английски такой вопрос начинается " +
              "словом What, за ним идут are и you, а в конце стоит doing.",
        ...
        },
        {
          ...
          text: [
            "Что делают они",
            "Когда спрашиваем о нескольких людях, после What стоит are, а отвечаем словом they.",
        ...
        },
        {
          ...
          why:
            "Получается вопрос What are your sisters doing? Сестёр несколько, поэтому после What " +
            "стоит are.",
        },
        {
          /* З3. ПРОИЗВЕСТИ. Порядок один. */
          ...
          why:
            "Получается вопрос What are your friends doing? Друзей несколько, поэтому после What " +
            "стоит are, а doing стоит в конце.",
        },
        {
          /*
      ...
      blocks: [
        ...
        },
        {
          ...
          why:
            ...
            "смотрит телевизор. Вопрос начат словом is, поэтому и короткий ответ стоит на is. " +
        ...
        },
        {
          ...
          answer: "table",
          accept: ["the table"],
          hint: "Найди строку о собаке и посмотри, что стоит после under.",
  ...
  quiz: {
    ...
    questions: [
      ...
      },
      {
        ...
        why:
          "Получается строка Aigerim and Nurlan are playing in the garden. Имён два, поэтому стоит " +
          "are, а глагол play получает окончание -ing.",
      },
    ],
  },
};
