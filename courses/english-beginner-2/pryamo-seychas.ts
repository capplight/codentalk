...
const modul: Module = {
  ...
  lessons: [
      ...
      blocks: [
        ...
        },
        {
          ...
          text: [
            ...
            "I am a student. I am studying. — Я ученик. Я учусь.",
          ],
...

    {
      ...
      vstuplenie:
        "Алим пишет другу о том, что его родные делают прямо сейчас. По-русски мы говорим " +
      ...
      blocks: [
        {
          ...
          explain:
            "В каждой строке Алим говорит, что кто-то из его родных делает прямо сейчас. Так он " +
        ...
        },
        {
          ...
          kind: "table",
          znak: "1f4c3",
          caption: "Форма be меняется, а глагол в этих строках стоит с окончанием -ing",
          head: ["Строка", "Перевод"],
          rows: [
            ["I am reading", "Я читаю"],
        ...
        },
        {
          ...
          text: [
            "Он и она: is",
            "После he и после she ставим is, а глагол стоит с окончанием -ing.",
        ...
        },
        {
          ...
          text: [
            "Мы и они: are",
            "Слово we значит «мы», а they значит «они». После них ставим форму are.",
        ...
        },
        {
          ...
          text: [
            "Имена и родные: are",
            "Если вместо they стоят имена через and или слово о нескольких родных, например my " +
              "parents, ставим are.",
        ...
        },
        {
          ...
          text: [
            ...
            "О собаке или кошке в этих строках говорим словом it. В таблице это слово переведено " +
              "«оно», а по-русски о собаке и о кошке мы говорим «она». В модуле «Что это такое» " +
              "слово it стояло о вещи.",
        ...
        },
        {
          ...
          text: [
            "Ты: you are",
            "Собеседник один, а форма после you всё равно are, как и в модуле «Какой человек».",
        ...
        },
        {
          ...
          text: [
            ...
            "Коротко пишем не только I'm. Записи he's и she's мы разбирали в модуле " +
              "«Здравствуйте, меня зовут», а they are коротко пишем they're.",
        ...
        },
        {
          ...
          why:
            "Получается строка Aigerim and Nurlan are drinking tea. Два имени через and стоят " +
            "вместо they, поэтому стоит форма are.",
        },
        {
        ...
        },
        {
          ...
          why:
            "My brother is working. My sister is sleeping. Каждая строка говорит об одном " +
            "человеке, поэтому в ней стоит is. Ответ на это задание не проверяется, поэтому " +
...

    {
      ...
      blocks: [
        ...
        },
        {
          ...
          znak: "1f4da",
          text: [
            "Буква y остаётся: studying",
            "В модуле «Что я делаю каждый день» после she глагол study писали studies, и буква y " +
              "менялась на i. Перед окончанием -ing она остаётся на месте.",
        ...
        },
        {
          ...
          text: [
            "Вставать: get up",
            "Окончание получает первое слово, get, и букву t в нём пишем два раза. Второе слово " +
              "остаётся прежним.",
            "get up — getting up",
        ...
        },
        {
          ...
          hint: "Подумай, что происходит с буквой y перед окончанием -ing.",
          why:
            "Верно studying. Перед окончанием -ing буква y остаётся на месте. В записи studiing " +
            "буква y сменилась на i, как в studies, а в записи studing она пропала.",
        },
        {
...

    {
      ...
      vstuplenie:
        ...
        "По-английски это две разные строки. Одна говорит о том, что человек делает обычно, а " +
        "другая говорит об этой минуте. Здесь мы разберём, чем они различаются.",
      ...
      blocks: [
        ...
        },
        {
          ...
          text: [
            ...
            "В строке о том, что делаем обычно, стоит один глагол. В строке об этой минуте стоят " +
              "am и глагол с окончанием -ing.",
        ...
        },
        {
          ...
          text: [
            "Каждый день и now",
            "Оборот every day стоит в строке о том, что делаем обычно, а слово now стоит в " +
              "строке о том, что идёт сейчас.",
        ...
        },
        {
          ...
          text: [
            "Он, она и имя: -s и is",
            "О нём, о ней или о человеке по имени говорим двумя способами. Если это то, что " +
              "человек делает обычно, у глагола стоит окончание -s. Если это идёт сейчас, " +
              "ставим is и глагол с окончанием -ing.",
        ...
        },
        {
          ...
          text: [
            ...
            "Оборот in the morning мы брали в модуле «Что я делаю каждый день». В строке с ним " +
              "ниже речь о каждом утре, а строка с глаголом на -ing говорит об этой минуте.",
        ...
        },
        {
          ...
          text: [
            ...
            "Строка о том, что человек делает обычно, и строка об этой минуте стоят рядом. " +
              "Первая говорит, кем человек работает, а вторая говорит, что он делает прямо сейчас.",
        ...
        },
        {
          ...
          znak: "26a0",
          text:
            "Строка о том, что делаем обычно\n\nО том, что делаем обычно, говорим одним " +
            "глаголом.\n\nВ записи I am work every day. рядом стоят am и глагол без " +
            "окончания, и так по-английски не говорят. Верной будет строка I work every day.",
        ...
        },
        {
          ...
          kind: "match",
          prompt: "Соедини строку о Киме с её переводом.",
        ...
        },
        {
          ...
          why:
            "Aigerim swims every evening. Now she is swimming. В первой строке один глагол, " +
            "потому что речь о каждом вечере, а окончание -s у него потому, что речь об Айгерим. " +
            "Во второй строке стоят is и глагол с окончанием -ing, потому что речь об этой " +
            "минуте. Вторую строку можно написать и без now.",
        },
        {
...

    {
      ...
      vstuplenie:
        "По-русски мы говорим «на ней красное платье». По-английски о том, что надето на " +
        "человеке, говорим с глаголом wear. Здесь мы разберём, как строятся такие строки.",
      ...
      blocks: [
        {
          ...
          text: [
            "На ней платье",
            "Русское «на ней» по-английски начинается с she, а «на нём» с he. За ними идут " +
              "форма be, wearing и название одежды.",
        ...
        },
        {
          ...
          text: [
            ...
            "Слово о цвете встаёт перед названием одежды, как в модуле «Цвет и размер» и в " +
              "русской фразе «синяя рубашка». Строка с wearing держит тот же порядок.",
        ...
        },
        {
          ...
          text: [
            "На них",
            "После they или слова о нескольких родных, например my sisters, ставим are, а глагол " +
              "wear остаётся с окончанием -ing.",
        ...
        },
        {
          ...
          text: [
            "Очки и джинсы",
            "Glasses и jeans, как и русские «очки» и «джинсы», стоят во множественном числе, " +
        ...
        },
        {
          ...
          text: [
            "have got и wearing",
            "В модуле «Одежда» оборот have got говорил, что вещь у человека есть. Строка с формой " +
              "be и wearing говорит, что вещь на нём прямо сейчас.",
        ...
        },
        {
          ...
          znak: "26a0",
          text:
            "Человек и его одежда\n\nКогда говорим, что на человеке надето, ставим форму be " +
            "и wearing.\n\nВ записи Nurlan is a blue shirt. сказано, что Нурлан — это синяя " +
            "рубашка, и так по-английски не говорят. Верной будет строка Nurlan is wearing a " +
            "blue shirt.",
        ...
        },
        {
          ...
          hint: "Проверь, чем кончается глагол после is.",
          why:
            "Верна строка Aigerim is wearing a white T-shirt. В записи Aigerim wearing a white " +
            "T-shirt. нет формы be. В записи Aigerim is wear a white T-shirt. у глагола нет " +
            "окончания -ing.",
        },
        {
          /* З2. ПРОИЗВЕСТИ. */
          ...
          after: " a black coat.",
          answer: "wearing",
          hint: "Строка говорит, что на брате надето прямо сейчас.",
          why:
        ...
        },
        {
          ...
          kind: "match",
          prompt: "Соедини строку о шляпе с её переводом.",
          ...
          why:
            ...
            "вещь есть, а строка с am и wearing говорит про эту минуту. Строка с every day " +
            "говорит о том, что делаем обычно.",
        },
        {
          /*
          ...
          why:
            "Верной будет строка We are wearing black jackets. После we ставим are, а за ним идёт " +
            "глагол wear с окончанием -ing.",
        },
        {
          /* З5. О СЕБЕ. Один голос: не разговор. */
...

    {
      ...
      blocks: [
        ...
        },
        {
          ...
          kind: "table",
          znak: "1f4c3",
          caption: "Форма be с not меняется, а глагол в этих строках стоит с окончанием -ing",
          head: ["Строка", "Перевод"],
          rows: [
        ...
        },
        {
          ...
          text: [
            "Мы и они: aren't",
            "После we и they ставим aren't, а за ним глагол с окончанием -ing.",
        ...
        },
        {
          ...
          text: [
            ...
            "Короткая запись aren't значит то же, что полная are not, и верны обе.",
            "We are not eating. — Мы не едим.",
            "We aren't eating. — Мы не едим.",
          ],
        ...
        },
        {
          ...
          znak: "1f464",
          text: [
            "Имена и родные: aren't",
            "Если вместо they стоят имена через and или слово о нескольких родных, например my " +
              "parents, ставим aren't.",
        ...
        },
        {
          ...
          kind: "choice",
          prompt:
            "Друзья Кима сейчас не спят. Какая строка написана без ошибки?",
          options: [
            { text: "They isn't sleeping now." },
            { text: "They aren't sleeping now.", correct: true },
            { text: "They aren't sleep now." },
          ],
          hint: "Посмотри, какая форма be стоит после they.",
          why:
            "Верна строка They aren't sleeping now. В записи They isn't sleeping now. после they " +
            "стоит is, а после they ставим are. В записи They aren't sleep now. у глагола нет " +
            "окончания -ing.",
        },
        {
          ...
          why:
            "Получается строка My sisters aren't swimming now. После слова о нескольких родных " +
            "стоит are, а not вошло в короткую запись aren't. Полная запись are not тоже верна.",
        },
        {
          ...
          why:
            "Получается строка I am not working now. Она говорит о том, чего человек не делает в " +
            "эту минуту. Поэтому в ней стоят am и not, а глагол идёт с окончанием -ing.",
        },
        {
          ...
          kind: "choice",
          prompt:
            "Алим работает поваром, но сейчас он в отпуске и не готовит. Какая строка говорит о " +
            "том, чего Алим не делает сейчас?",
          options: [
            { text: "He isn't a cook." },
            { text: "He doesn't cook." },
            { text: "He isn't cooking now.", correct: true },
          ],
          hint: "Ищи строку, которая говорит об этой минуте.",
          why:
            "Верна строка He isn't cooking now. Строка He isn't a cook. говорит, что Алим не " +
            "повар, а он повар. Строка He doesn't cook. говорит о том, чего Алим не делает " +
            "обычно, а обычно он готовит. Обе написаны без ошибки, но с условием не сходятся.",
        },
        {
          /*
...

    {
      ...
      vstuplenie:
        "По-русски вопрос «ты спишь?» отличается от строки «ты спишь» только голосом. " +
        "По-английски у вопроса свой порядок слов, как и в модуле «Откуда ты и где живёшь». " +
        "Здесь мы разберём вопрос о том, что человек делает сейчас, и короткий ответ на него.",
      ...
      blocks: [
        {
          ...
          znak: "1f504",
          text: [
            "Из обычной строки получается вопрос",
        ...
        },
        {
          ...
          znak: "2753",
          text: [
            "Вопрос к собеседнику: Are you…?",
            "Перед you в вопросе встаёт are.",
        ...
        },
        {
          ...
          text: [
            ...
            "Форма is встаёт перед he, she, именем или словом о родном, например your brother.",
        ...
        },
        {
          ...
          text: [
            "Вопрос о нескольких",
            "Перед they или словом о нескольких родных, например your parents, встаёт are.",
            "Are they swimming? — Они плавают?",
            "Are your parents eating? — Твои родители едят?",
          ],
        ...
        },
        {
          ...
          text: [
            "Короткий ответ «да»",
            "По-русски мы отвечаем одним словом «да». По-английски после Yes стоят ещё " +
              "местоимение и форма be, как в модуле «Откуда ты и где живёшь».",
            "Yes, I am. — Да.",
            "Yes, she is. — Да.",
          ],
        ...
        },
        {
          ...
          text: [
            "Короткий ответ «нет»",
            "В ответе «нет» после No стоят местоимение и форма be с not. В строках ниже они " +
              "записаны коротко.",
            "No, I'm not. — Нет.",
            "No, he isn't. — Нет.",
          ],
...

        {
          ...
          text: [
            ...
            "В модуле «Спросить о делах» вопрос о том, что человек делает вообще, начинали " +
              "словом do. Вопрос о том, что он делает сейчас, начинаем формой be. В ответе снова " +
              "стоит do или форма be, только уже о себе.",
        ...
        },
        {
          ...
          znak: "23f1",
          text: [
            "Вопрос со словом now",
            "Слово now встаёт в конце вопроса, как и в конце обычной строки.",
            "Are you working now? — Ты сейчас работаешь?",
            "Is he sleeping now? — Он сейчас спит?",
          ],
        ...
        },
        {
          ...
          kind: "choice",
          prompt:
            "Дана пишет: Kim is eating. Отметь вопрос о том же самом.",
          options: [
            { text: "Is Kim eat?" },
            { text: "Does Kim eating?" },
            { text: "Is Kim eating?", correct: true },
          ],
          hint: "Вопрос получится, если в строке Даны переставить одно слово.",
          why:
            "Верен вопрос Is Kim eating? В записи Is Kim eat? после is стоит глагол без " +
            "окончания -ing. В записи Does Kim eating? слово does взято из вопроса о том, что " +
            "человек делает обычно.",
        },
        {
          /* З2. ПРОИЗВЕСТИ. Короткий ответ. */
          id: "z2-vpisat-korotkiy-otvet",
          kind: "gap",
          prompt: "Твои родители сейчас работают. Ответь «да» и впиши недостающее слово.",
          before: "Are your parents working? — Yes, they ",
          after: ".",
          answer: "are",
          hint: "Ответ повторяет форму be из вопроса.",
          why:
            "Получается ответ Yes, they are. Вопрос о your parents начат словом are, и в коротком " +
            "ответе с they тоже стоит are.",
        },
        {
          /* З3. ПРОИЗВЕСТИ. Порядок один. */
          id: "z3-sobrat-vopros-o-sestre",
          kind: "order",
          prompt: "Собери вопрос «твоя сестра танцует?».",
          items: ["dancing?", "Is", "your sister"],
          answer: [1, 2, 0],
          hint: "Вопрос начни с формы be.",
          why:
            "Получается вопрос Is your sister dancing? Сестра одна, поэтому впереди стоит is, а " +
            "за ним идёт тот, о ком речь.",
        },
        {
          ...
          kind: "short",
          prompt:
            "Ты звонишь Алиму и хочешь узнать, готовит ли он сейчас. Обратись к нему и задай вопрос.",
          ...
          hint: "Ты говоришь с Алимом, а не о нём.",
          why:
            "Верен вопрос Are you cooking now? Ты спрашиваешь самого Алима, поэтому в вопросе " +
            "стоит you, а форма are встаёт перед ним.",
        },
        {
          /*
          ...
          kind: "speak",
          prompt:
            "Скажи вслух разговор из двух реплик. Спроси собеседницу, читает ли она сейчас, а " +
            "потом ответь вместо неё: «нет, я пишу».",
          ...
          why:
            "Are you reading? — No, I'm not. I'm writing. Вопрос начат формой be, и в ответе " +
            "снова стоит форма be, только уже о себе. Потом собеседница говорит, что делает " +
            "вместо чтения. Ответ на это задание не проверяется, поэтому сверься с образцом. " +
...

    {
      ...
      vstuplenie:
        "Дана звонит Киму вечером и спрашивает, что он делает. По-русски она сказала бы «что ты " +
        "делаешь?». Здесь мы разберём этот вопрос по-английски и ответы на него.",
      ...
      blocks: [
        {
          ...
          razgovor: true,
          pervyyGolos: "zhenskiy",
          caption: "Дана звонит Киму вечером. Первой говорит Дана",
          text: "Hi, Kim! What are you doing?\nI am doing my homework.",
          perevod: {
            "Hi, Kim! What are you doing?": "Привет, Ким! Что ты делаешь?",
            "I am doing my homework.": "Я делаю домашнюю работу.",
          },
          explain:
            "Дана хочет знать, чем Ким занят в эту минуту. Ким отвечает, что сейчас он делает " +
            "домашнюю работу.",
        },
        {
          ...
          text: [
            ...
            "По-русски мы спрашиваем «что ты делаешь?». По-английски «что» передаёт слово What, " +
              "а «делаешь» передаёт doing, то есть глагол do с окончанием -ing. Между ними форма " +
              "be стоит перед you, как в вопросах урока «Ты читаешь? Are you reading?».",
            "What are you doing? — I am cooking. — Что ты делаешь? — Я готовлю.",
            "What are you doing? — I am reading. — Что ты делаешь? — Я читаю.",
          ],
          zvuchat: [
        ...
        },
        {
          ...
          text: [
            "Откуда слово doing",
            "В модуле «Спросить о делах» словом do начинали вопрос, и оно не переводилось. У " +
              "этого слова есть и второе значение, «делать», и в модуле «Как часто» оно стояло в " +
              "строке о домашней работе. С окончанием -ing слово do говорит о том, что делают " +
              "прямо сейчас.",
            "I am doing my homework. — Я делаю домашнюю работу.",
            "She is doing her homework. — Она делает домашнюю работу.",
          ],
        ...
        },
        {
          ...
          text: [
            ...
            "После What стоит is, а за ним he, she, имя или слово о родном, например your father.",
        ...
        },
        {
          ...
          text: [
            "Что делают они",
            "Если спрашиваем о they или о нескольких родных, например your parents, после What " +
              "стоит are. В ответе о них стоит they.",
            "What are they doing? — They are playing football. — Что они делают? — Они играют в футбол.",
            "What are your parents doing? — They are walking. — Что делают твои родители? — Они гуляют.",
          ],
          zvuchat: [
        ...
        },
        {
          ...
          text: [
            "Ответ одним словом",
            "В разговоре на вопрос с What можно ответить и одним словом, глаголом с окончанием " +
              "-ing. Полный ответ при этом тоже верен.",
            "What is the man doing? — Eating. — Что делает мужчина? — Ест.",
            "What are you doing? — Swimming. — Что ты делаешь? — Плаваю.",
          ],
        ...
        },
        {
          ...
          text: [
            ...
            "Вопрос Where are you? мы разбирали в модуле «Откуда ты и где живёшь». Его можно " +
              "задать рядом с вопросом о том, что человек делает.",
            "Where are you? — I am in the garden. — Где ты? — Я в саду.",
            "What are you doing? — I am drawing. — Что ты делаешь? — Я рисую.",
          ],
        ...
        },
        {
          ...
          znak: "1f501",
          text: [
            "Вопрос в ответ: And you?",
            "Ответив, можно вернуть вопрос собеседнику словами And you?, как в модуле «Откуда ты " +
              "и где живёшь».",
            "I am eating. And you? — Я ем. А ты?",
            "I am working. And you? — Я работаю. А ты?",
          ],
        ...
        },
        {
          ...
          text: [
            "Ответ о действии",
            "На вопрос с What отвечаем действием, а не словами yes или no. Действие можно назвать " +
              "одним словом или целой строкой.",
        ...
        },
        {
          ...
          kind: "choice",
          prompt:
            "Тебя спросили про Нурлана: What is Nurlan doing? Отметь верный ответ.",
          options: [
            { text: "Yes, he is." },
          ...
          why:
            "Верен ответ He is drinking coffee. Ответ Yes, he is. подходит к вопросу «да или нет», " +
            "а на вопрос с What отвечаем действием. В записи He drinking coffee. нет формы be.",
        },
        {
          /* З2. ПРОИЗВЕСТИ. */
          id: "z2-vpisat-formu-be-v-vopros",
          kind: "gap",
          prompt: "Впиши форму be в вопрос о твоих сёстрах.",
          before: "What ",
          after: " your sisters doing?",
          answer: "are",
          hint: "Посмотри, о скольких людях вопрос.",
          why:
            "Получается вопрос What are your sisters doing? Речь о нескольких родных, поэтому после " +
            "What стоит are.",
        },
        {
          /* З3. ПРОИЗВЕСТИ. Порядок один. */
          ...
          kind: "order",
          prompt: "Собери вопрос «что делают твои друзья?».",
          items: ["your friends", "doing?", "What", "are"],
          answer: [2, 3, 0, 1],
          hint: "Вопрос начинается словом What.",
          why:
            "Получается вопрос What are your friends doing? Слова your friends говорят о нескольких " +
            "людях, поэтому после What стоит are, а doing стоит в конце.",
        },
        {
          /*
          ...
          kind: "speak",
          prompt:
            "Разыграй разговор вслух. Друг спрашивает, что ты делаешь. Ответь ему и верни " +
            "вопрос.",
          phrase: "What are you doing? — I am learning English. And you?",
          pervyyGolos: "muzhskoy",
          translation: "Что ты делаешь? — Я учу английский. А ты?",
          hint: "После ответа верни вопрос двумя словами из урока.",
          why:
            "What are you doing? — I am learning English. And you? Ответ говорит о том, что " +
            "человек делает сейчас, а слова And you? возвращают вопрос другу. Ответ на это " +
            "задание не проверяется, поэтому сверься с образцом. Послушай его и повтори следом " +
            "за ним.",
        },
      ],
    },

    {
      ...
      vstuplenie:
        "В выходной Айгерим пишет подруге Дане о том, что у них дома происходит прямо сейчас. " +
        "По-русски такое сообщение отвечает на вопрос «кто чем занят?». Здесь мы разберём её " +
        "сообщение и найдём в нём, кто что делает.",
      ...
      blocks: [
        ...
        },
        {
          ...
          prompt: "Что сейчас делает папа Айгерим?",
          options: [
            { text: "cooking lunch" },
            { text: "watching television" },
            { text: "washing his bike", correct: true },
          ],
          hint: "Найди в сообщении строку, которая начинается словами My father.",
          why:
            "Верно washing his bike. В сообщении стоит строка My father is washing his bike. Обед " +
            "готовит мама, а телевизор смотрит Нурлан.",
        },
        {
          ...
          kind: "choice",
          about: "tekst-soobshchenie-aygerim",
          prompt: "Дана спрашивает: Is Nurlan doing his homework? Отметь верный ответ.",
          options: [
            { text: "No, he isn't.", correct: true },
            { text: "Yes, he is." },
            { text: "No, he doesn't." },
          ],
          hint: "Найди в сообщении строку о Нурлане.",
          why:
            "Верен ответ No, he isn't. Айгерим пишет, что Нурлан не делает домашнюю работу, а " +
            "смотрит телевизор. Вопрос начат словом is, поэтому и в коротком ответе стоит is. " +
            "Ответ No, he doesn't. годится для вопроса со словом does.",
        },
        {
          ...
          about: "tekst-soobshchenie-aygerim",
          prompt:
            "Где спит собака? Запиши одним английским словом, под чем она спит.",
          answer: "table",
          accept: ["the table"],
          hint: "Найди в сообщении строку о собаке.",
          why: "Верно table. В сообщении сказано, что собака спит под столом: Our dog is sleeping under the table.",
        },
        {
          /*
          ...
          kind: "choice",
          about: "tekst-soobshchenie-aygerim",
          prompt: "Что делает сама Айгерим?",
          options: [
            { text: "She is sleeping." },
            { text: "She is writing to Dana.", correct: true },
            { text: "She is cooking lunch." },
          ],
          hint: "Найди строку, которая начинается с I.",
          why:
            "Верно She is writing to Dana. О себе Айгерим пишет в конце: I am writing to you. " +
            "Обед готовит мама, а под столом спит собака.",
        },
      ],
    },

    {
      ...
      vstuplenie:
        "Айгерим звонит Киму и спрашивает, где он и где их друзья. По-русски она начала бы " +
        "разговор словами «привет, ты где?». Здесь мы разберём на слух, кто из друзей что делает.",
      ...
      blocks: [
        {
          ...
          skryt: true,
          pervyyGolos: "zhenskiy",
          caption: "Айгерим звонит Киму. Первой говорит Айгерим",
          transcript:
        ...
        },
        {
          ...
          prompt: "Соедини имя с тем, что человек делает.",
          left: ["Alim", "Dana", "Bill"],
          right: ["drawing", "playing football", "walking"],
          answer: [2, 0, 1],
          hint: "Ким говорит о друзьях по очереди, в том же порядке, что и имена слева.",
          why:
            "Верны пары Alim — walking, Dana — drawing, Bill — playing football. Ким говорит, что " +
            "Алим гуляет, Дана рисует, а Билл играет в футбол.",
        },
        {
          ...
          kind: "short",
          about: "zapis-aygerim-zvonit-kimu",
          prompt: "Что рисует Дана? Запиши одним английским словом.",
          answer: "bird",
          accept: ["a bird"],
          hint: "Слушай ту часть разговора, где Ким говорит о Дане.",
          why: "Верно bird. Ким говорит о Дане: She is drawing a bird. Дана рисует птицу.",
        },
        {
          /* З3. Где говорящий. */
          ...
          kind: "choice",
          about: "zapis-aygerim-zvonit-kimu",
          prompt: "Где сейчас Ким?",
          options: [{ text: "at home" }, { text: "in the park", correct: true }, { text: "at school" }],
          hint: "Ответ звучит в самом начале разговора.",
          why: "Верно in the park. На вопрос Айгерим Where are you? Ким отвечает: I am in the park.",
        },
        {
          /*
...

    {
      ...
      vstuplenie:
        "Представь картинку: мужчина читает газету, женщина готовит, кошка спит под столом, " +
        "дети играют. Здесь мы разберём, как сказать о ней по-английски.",
      ...
      blocks: [
        {
          ...
          text: [
            "Что на картинке",
            "На картинке четыре части. Каждую мы опишем по-английски отдельной строкой.",
        ...
        },
        {
          ...
          kind: "gap",
          znak: "1f4f0",
          prompt: "Первая подпись: «мужчина читает газету». Впиши глагол.",
          before: "The man is ",
          after: " a newspaper.",
          answer: "reading",
          hint: "Подумай, какой глагол значит «читать».",
          why:
            "Получается строка The man is reading a newspaper. Картинка показывает то, что идёт " +
            "сейчас, поэтому после is стоит глагол с окончанием -ing.",
        },
        {
          ...
          znak: "1f408",
          prompt:
            "Третья подпись: «кошка спит под столом». Собери строку и начни с The cat.",
          items: ["under", "the table.", "is sleeping", "The cat"],
          answer: [3, 2, 0, 1],
          hint: "Сначала скажи, что кошка делает, а потом где.",
          why:
            "Получается строка The cat is sleeping under the table. После The cat стоят is и " +
            "глагол с окончанием -ing, а место названо в конце.",
        },
        {
          ...
          znakov: 2,
          prompt:
            "Четвёртая подпись: «дети играют». Напиши об этом строку по-английски.",
          ...
          hint: "Детей несколько, и форма be это показывает.",
          why:
            "Верна строка The children are playing. Слово children говорит о нескольких людях, " +
            "поэтому стоит are, а глагол play идёт с окончанием -ing.",
        },
        {
          /* З4. ОПИСАТЬ ВСЮ КАРТИНКУ. Один голос: это не разговор. */
          id: "z4-skazat-chetyre-stroki-o-kartinke",
          kind: "speak",
          prompt: "Скажи вслух четыре строки о картинке, по одной о каждой подписи.",
          phrase:
            "The man is reading. The woman is cooking. The cat is sleeping. The children are playing.",
          translation: "Мужчина читает. Женщина готовит. Кошка спит. Дети играют.",
          hint: "О детях говорим are, а обо всех остальных is.",
          why:
            "The man is reading. The woman is cooking. The cat is sleeping. The children are " +
            "playing. О мужчине, женщине и кошке стоит is, а о детях are, потому что их " +
            "несколько. Ответ на это задание не проверяется, поэтому сверься с образцом. " +
            "Послушай его и повтори следом за ним.",
        },
      ],
    },
    ...
    questions: [
      {
        ...
        outcome: "говорить, что надето на человеке: is wearing и название одежды",
        prompt:
          "Дана пишет Алиму из магазина: I am wearing a new dress. Алим тут же рассказывает " +
          "брату, что надето на Дане. Как он это скажет? Запиши его строку по-английски.",
        ...
        why:
          ...
          "говорит о ней, поэтому вместо I am стоит Dana is или she is.",
      },
      {
        /*
        ...
        outcome:
          "различать строку о том, что бывает каждый день, и строку о том, что идёт сейчас",
        prompt:
          "Айгерим работает учительницей. Сегодня выходной, и сейчас она спит. Какая строка " +
          "говорит о том, что она делает в эту минуту?",
        options: [
          { text: "She sleeps." },
          { text: "She is sleep." },
        ...
        why:
          "Верна строка She is sleeping. Строка She sleeps. тоже написана верно, но она говорит о " +
          "том, что бывает обычно. В записи She is sleep. после is стоит глагол без окончания -ing.",
      },
      {
        ...
        outcome: "спрашивать, делает ли человек это сейчас, и коротко отвечать",
        prompt:
          "Дана оставила дома записку: I am in the park. I am walking. Папа читает её и спрашивает: " +
          "Is Dana sleeping? Как коротко ему ответить?",
        answer: "No, she isn't.",
        accept: ["No, she is not.", "No, she's not."],
        why:
          "Верен ответ No, she isn't. Дана пишет, что она в парке и гуляет, значит сейчас она не " +
          "спит. В коротком ответе снова стоит is, к которому прибавлено not.",
      },
      {
        /*
        ...
        outcome: "писать форму на -ing у глаголов, где написание меняется",
        prompt:
          "Твои братья сейчас бегают в парке. Какая форма глагола run встанет в пропуск?",
        before: "My brothers are ",
        after: " in the park.",
        answer: "running",
        why:
          "Получается строка My brothers are running in the park. У глагола run последняя буква " +
          "перед -ing пишется два раза, как у swim.",
      },
      {
        /*
        ...
        outcome: "писать форму на -ing у глаголов, где написание меняется",
        prompt:
          "В сообщении Кима стоит: Dana is rideing a bike. Что в этой записи не так?",
        options: [
        ...
        why:
          "У ride на конце стоит e, а перед окончанием -ing её не пишем. Само окончание здесь " +
          "нужно, потому что строка говорит о том, что идёт сейчас. Удваивать d тоже не нужно. " +
          "Последнюю букву пишем дважды у swim, sit, run и get, а ride в этот ряд не входит.",
      },
      {
        /*
        ...
        outcome: "говорить о себе, что делаешь сейчас: I am reading",
        prompt:
          "Нурлан прислал сообщение. В одном слове у него пропало окончание -ing. Отметь это слово.",
        parts: [
        ...
        why:
          "Ошибка в слове sit. Верной будет строка I am sitting in the garden. Две другие строки " +
          "написаны верно, в них после is стоит глагол с окончанием -ing.",
      },
      {
        /*
        ...
        outcome:
          "говорить, что человек сейчас этого не делает: isn't и aren't с глаголом на -ing",
        prompt:
          "Мама спрашивает: Is Aigerim cooking? Но Айгерим не готовит, а танцует. Ответь маме " +
      ...
      },
      {
        ...
        outcome:
          "говорить, что сейчас делает другой человек или несколько людей: is и are с глаголом на -ing",
        prompt:
          "Дана пишет подруге: I am swimming. Айгерим пишет то же самое. Запиши одну строку " +
          "сразу о них обеих.",
        ...
        why:
          "Верна строка Dana and Aigerim are swimming. Каждая писала о себе и ставила am. Об " +
          "обеих сразу говорим как о they, поэтому am меняется на are, а глагол сохраняет " +
          "окончание -ing. Годится и строка They are swimming.",
      },
      {
        /*
        ...
        outcome: "спрашивать, что человек делает сейчас, и отвечать на такой вопрос",
        prompt:
          "Дана ответила на вопрос о брате: He is drawing. Каким был вопрос? Запиши его со словом " +
          "What.",
        ...
        why:
          "Вопрос был таким: What is your brother doing? Речь об одном человеке, поэтому после What " +
          "стоит is. Вопрос со словом he вместо your brother тоже верен.",
      },
      {
        /*
        ...
        kind: "hottext",
        outcome: "находить в сообщении, кто что делает сейчас",
        prompt: "Это сообщение Алима. Отметь строку о том, что его жена делает прямо сейчас.",
        parts: [
        ...
        why:
          "Верна строка Now she is reading. Строка My wife teaches at a school. говорит о том, " +
          "что жена делает обычно, а не об этой минуте. Остальные строки говорят о самом Алиме " +
          "или о дне.",
      },
      {
        /*
        ...
        pervyyGolos: "muzhskoy",
        prompt: "Послушай разговор. Что Дана делает сейчас?",
        options: [
          { text: "washing", correct: true },
          { text: "driving" },
          { text: "sleeping" },
        ],
        why: "Дана говорит о себе: I am washing my car. Значит, сейчас она моет машину.",
      },
      {
        /*
        ...
        outcome: "строить строки о том, кто что делает на картинке",
        prompt:
          "Айгерим и Нурлан прямо сейчас играют в саду. Составь об этом строку из слов: " +
          "Aigerim and Nurlan, play, in the garden.",
        ...
        why:
          "Получается строка Aigerim and Nurlan are playing in the garden. Вместе Айгерим и " +
          "Нурлан — это they, поэтому стоит are, а глагол play получает окончание -ing.",
      },
    ],
  },
};
