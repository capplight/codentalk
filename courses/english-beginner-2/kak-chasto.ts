  ...
  lessons: [
...

    {
      ...
      blocks: [
         ...
         */
        {
          ...
          answer: "never",
          hint: "Знакомая Кима отвечает двумя предложениями. Нужное слово стоит в том, где звучит newspapers.",
          why: "never, то есть никогда. Знакомая Кима ответила: No, I never read newspapers.",
        },
        {
          id: "z2-zapisat-chto-chitaet-inogda",
          kind: "short",
          prompt: "Что она читает иногда? Запиши одним английским словом.",
          answer: "magazine",
          accept: ["a magazine"],
        ...
        },
        {
          ...
          hint: "О днях без работы Нурлан говорит в последнем предложении. Нужное слово стоит в самом его конце.",
...

    {
      ...
      vstuplenie:
        ...
        "несколькими строками и в каждой выбрать наречие частоты.",
      ...
      blocks: [
         ...
         */
        {
          ...
          why:
            ...
            "строке наречие частоты стоит после I и перед глаголом, а оборот in the morning стоит в конце строки. " +
        ...
        },
        {
          ...
          kind: "speak",
          prompt:
            "Расскажи вслух о себе двумя строками. В первой скажи, где у тебя всегда много дел, а во второй " +
            "скажи, что ты часто делаешь вечером.",
          phrase: "I am always busy at school. I often dance in the evening.",
          translation: "Я всегда занят в школе. Я часто танцую вечером.",
          hint: "О делах скажи словом busy. Наречие always стоит между формой be и этим словом.",
          why:
        ...
        },
        {
          ...
          answer: [1, 3, 0, 2],
          hint: "Строка начинается с I, а кусок с точкой ставь последним.",
          why:
    ...
    questions: [
      {
        ...
        why:
          "I sometimes read a newspaper. Слово always значит «всегда», а Нурлан хотел сказать «иногда», поэтому в " +
      ...
      },
      {
        ...
        outcome: "говорить одним словом never, что чего-то не бывает никогда",
        prompt:
          "Ученик хотел сказать, что никогда не ест мясо, и написал: I don't eat meat. Строка верна, но слова " +
          "«никогда» в ней нет. Перепиши строку так, чтобы в ней было это слово.",
      ...
      },
      {
        ...
        why:
          "I write to my uncle every month. После every слово о времени стоит в единственном числе, поэтому " +
          "окончание -s у month лишнее.",
      },
      {
        /*
        ...
        prompt:
          ...
          "Перепиши вопрос так, чтобы в нём было слово «часто».",
      ...
      },
      {
        ...
        outcome: "говорить, что бывает всегда и что иногда: I always work",
        prompt:
          "Ученик хотел сказать «Они всегда спят днём» и написал: They always in the afternoon sleep. Почему это " +
          "ошибка?",
        options: [
        ...
        why:
          "Верна строка They always sleep in the afternoon. Оборот in the afternoon стоит после глагола sleep, а " +
          "ученик поставил его туда, где «днём» стоит в русской фразе. Наречие always стоит на своём месте, и форма " +
          "are перед ним не нужна, потому что в строке есть глагол.",
      },
    ],
  },
};
