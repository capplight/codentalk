  ...
  lessons: [
    {
      ...
      vstuplenie:
        ...
        "строках слова «всегда» и «иногда» стоят перед глаголом. По-английски слово с таким " +
        "смыслом встаёт на то же место. Здесь мы разберём два таких слова и их место в строке.",
      ...
      blocks: [
        ...
        },
        {
          ...
          text: [
            ...
            "Когда в строку встаёт always или sometimes, глагол остаётся в том же виде, в каком " +
              "стоял без этого слова.",
            "I work. — Я работаю.",
        ...
        },
        {
          ...
          znak: "1f4da",
          text: [
            "Слова о частоте называются наречиями",
        ...
        },
        {
          ...
          kind: "table",
          znak: "1f4c3",
          caption: "Одна строка с двумя разными наречиями частоты",
          head: ["Строка", "Перевод"],
          rows: [
            ["I always work.", "Я всегда работаю."],
        ...
        },
        {
          ...
          why:
            "Верна строка Dana always cooks at home in the morning. Строка со словом sometimes " +
            "говорит, что утром Дана готовит не каждый раз. Третья строка говорит о вечере, " +
            "потому что в ней стоит in the evening.",
        },
        {
          /*
        ...
        },
        {
          ...
          kind: "gap",
          prompt:
            "Дана готовит дома каждый раз, без исключений. Впиши недостающее слово.",
          before: "Dana ",
          after: " cooks at home.",
          answer: "always",
        ...
        },
        {
          ...
          why:
            ...
            "sometimes тоже верно, и это место разбирает урок «Иногда — с начала: Sometimes I read».",
        },
        {
          /*
          ...
          answer: [2, 3, 1, 0],
          hint: "Наречие частоты встаёт перед глаголом.",
          why:
            "Собралась строка We always cook in the evening. Первым стоит We, за ним наречие " +
            "always, потом глагол cook, а оборот in the evening идёт в конце.",
        },
        {
          /*
          ...
          kind: "speak",
          prompt:
            "Скажи вслух о себе две строки. В первой скажи со словом always, что ты делаешь " +
            "всегда, а во второй скажи со словом sometimes, что ты делаешь иногда.",
          ...
          why:
            ...
            "обеих строках наречие частоты стоит перед глаголом, а оборот о времени идёт в конце. " +
