...
const modul: Module = {
  ...
  lessons: [
...

    {
      ...
      vstuplenie:
        "ПИШЕТ РЕДАКТОР: вступление начинается СЦЕНОЙ. Айгерим видится с бабушкой каждый месяц. Слова «часто» и " +
        "«иногда» не говорят, сколько времени проходит между встречами, а «каждый месяц» говорит. Без «не часто и не иногда» (решение методиста 3.4.1).",
      ...
      blocks: [
        ...
        },
        {
          ...
          text: [
            ...
            "ПИШЕТ РЕДАКТОР: правило: always срока не называет, а every week называет. Не противопоставлять «без исключений» (решение методиста 3.4.4).",
        ...
        },
        {
          ...
          kind: "table",
          znak: "1f4c3",
          caption: "ПИШЕТ РЕДАКТОР: подпись свода: оборот с every стоит в конце, и после every одно слово.",
          head: ["Строка", "Перевод"],
          rows: [
...

    {
      ...
      blocks: [
        ...
        },
        {
          ...
          kind: "order",
          prompt: "ПИШЕТ РЕДАКТОР: условие просит собрать вопрос. О месте слова о частоте не говорит.",
          items: ["often swim", "Do", "at the weekend?", "you"],
          answer: [1, 3, 0, 2],
          hint: "ПИШЕТ РЕДАКТОР: подсказка к сборке вопроса о плавании.",
          why: "ПИШЕТ РЕДАКТОР: разбор называет собранный вопрос о плавании.",
        },
        {
          /*
