      ...
      blocks: [
        ...
        },
        {
          ...
          text: [
            ...
            "Слово always не говорит, сколько времени проходит между двумя разами, а every week говорит, " +
              "что проходит неделя.",
        ...
        },
        {
          ...
          text: [
            ...
            "Обе строки о бабушке верны, но говорят разное. Первая говорит, что встречи бывают часто, а " +
              "вторая называет, сколько времени проходит между ними: месяц.",
