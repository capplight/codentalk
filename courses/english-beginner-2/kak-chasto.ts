...
const modul: Module = {
  ...
  lessons: [
...

    {
      ...
      vstuplenie:
        ...
        "проходит между встречами, а слова «каждый месяц» говорят. Здесь мы разберём, как назвать такой " +
        "срок по-английски.",
      ...
      blocks: [
        ...
        },
        {
          ...
          znak: "1f4cd",
          text: [
            "Оборот с every стоит в конце строки",
            "Сначала идут слово о том, кто делает, глагол и то, что к нему относится. Оборот с every " +
              "стоит после них, как оборот о времени in the evening.",
        ...
        },
        {
          ...
          znak: "1f475",
          text: [
            "Две строки о бабушке",
            "Слово often стоит перед глаголом, а оборот every month стоит в конце строки. Первая строка " +
              "говорит, что встречи бывают часто, а вторая говорит, что они бывают каждый месяц.",
            "I often see my grandmother. — Я часто вижусь с бабушкой.",
            "I see my grandmother every month. — Я вижусь с бабушкой каждый месяц.",
          ],
        ...
        },
        {
          ...
          kind: "table",
          znak: "1f4c3",
          caption: "Оборот с every стоит в конце строки, и после every одно слово в единственном числе",
          head: ["Строка", "Перевод"],
          rows: [
         ...
         */
        {
          ...
          kind: "choice",
          prompt: "Дана ходит в библиотеку каждую неделю. Отметь строку, где это сказано верно.",
          options: [
        ...
        },
        {
          ...
          hint: "Глагол для «вижусь» есть в словах этого урока. Оборот с every поставь в конце строки.",
          why:
        ...
        },
        {
          ...
          kind: "speak",
          prompt:
            "Скажи вслух две строки. Первая пусть говорит, что ты делаешь каждую неделю, а вторая, что " +
...

    {
      ...
      vstuplenie:
        "Ким знает, что Дана работает, и хочет узнать, работает ли она утром и каждое ли это утро. " +
      ...
      blocks: [
        ...
        },
        {
          ...
          text: [
            ...
            "В вопросе первым идёт do, а наречие частоты стоит на прежнем месте, между словом о том, кто " +
              "делает, и глаголом.",
        ...
        },
        {
          ...
          znak: "1f4ac",
          text: [
            "Короткий ответ остаётся прежним",
        ...
        },
        {
          ...
          text: [
            ...
            "Короткий ответ говорит «да» или «нет». Следующая строка с наречием частоты говорит, как часто " +
              "это бывает на самом деле.",
        ...
        },
        {
          ...
          text: [
            ...
            "О нескольких людях вопрос тоже начинается словом do. Наречие частоты стоит после they или your " +
              "friends, а глагол идёт без окончания.",
        ...
        },
        {
          ...
          explain:
            ...
            "словом always, каждое ли это утро. Дана отвечает «нет» и добавляет, что иногда работает вечером.",
        },
        {
      ...
      blocks: [
         ...
         */
        {
          ...
          why:
            ...
            "бабушке стоит оборот every month. Он называет срок, и наречием частоты его не считают.",
        },
        {
          ...
          why:
            "Верна строка She sees her grandmother. Плавает Айгерим иногда и в выходные, а чай пьёт часто и " +
            "утром. Каждый месяц она видится с бабушкой.",
        },
        {
          /*
        ...
        },
        {
          ...
          kind: "gap",
          prompt:
            "В записке Айгерим пишет, как часто она занимается дома вечером. Перескажи эту строку об " +
            "Айгерим и впиши недостающее слово.",
          before: "Aigerim ",
          after: " studies at home in the evening.",
          answer: "usually",
          hint: "Возьми наречие частоты из строки записки о занятиях дома.",
          why:
...

    {
      ...
      blocks: [
        ...
        },
        {
          ...
          kind: "short",
          prompt: "ПИШЕТ РЕДАКТОР: условие спрашивает, что она читает иногда (отвечает женский голос); ответ одним словом.",
          answer: "magazine",
          accept: ["a magazine"],
...

    {
      ...
      blocks: [
         ...
         */
        {
          ...
          kind: "speak",
          prompt: "ПИШЕТ РЕДАКТОР: условие просит рассказать о своём утре тремя строками: что бывает всегда, что обычно, чего не бывает никогда.",
          phrase: "I always drink milk in the morning. I usually cook breakfast. I never read in the morning.",
          translation: "ПИШЕТ РЕДАКТОР: перевод образца об утре.",
          hint: "ПИШЕТ РЕДАКТОР: подсказка к рассказу об утре.",
          why: "ПИШЕТ РЕДАКТОР: разбор под образец об утре с формулой самопроверки курса.",
        },
        {
          id: "z2-rasskazat-sometimes-i-every",
          kind: "speak",
          prompt: "ПИШЕТ РЕДАКТОР: условие просит рассказать о себе двумя строками: одну начать словом sometimes, во второй назвать точную частоту оборотом every.",
          phrase: "Sometimes I read in the afternoon. I see my cousin every month.",
          translation: "ПИШЕТ РЕДАКТОР: перевод образца с sometimes и every.",
          hint: "ПИШЕТ РЕДАКТОР: подсказка к рассказу с sometimes и every.",
          why: "ПИШЕТ РЕДАКТОР: разбор под образец с sometimes и every с формулой самопроверки курса.",
        },
        {
          id: "z3-rasskazat-kogda-mnogo-del",
          kind: "speak",
          prompt: "ПИШЕТ РЕДАКТОР: условие просит рассказать двумя строками, когда у тебя всегда много дел и что ты часто делаешь вечером. Без родового «занят».",
          phrase: "I am always busy at school. I often dance in the evening.",
          translation: "ПИШЕТ РЕДАКТОР: перевод образца о делах.",
          hint: "ПИШЕТ РЕДАКТОР: подсказка к рассказу о делах.",
          why: "ПИШЕТ РЕДАКТОР: разбор под образец о делах с формулой самопроверки курса.",
        },
        {
          id: "z4-otvetit-drugu",
          kind: "speak",
          prompt: "ПИШЕТ РЕДАКТОР: условие: друг спрашивает Do you often watch television? Ответить коротко и добавить строку о себе с наречием частоты.",
          phrase: "Do you often watch television? — No, I don't. I sometimes watch television in the evening.",
          translation: "ПИШЕТ РЕДАКТОР: перевод образца-разговора.",
          hint: "ПИШЕТ РЕДАКТОР: подсказка к ответу другу.",
          why: "ПИШЕТ РЕДАКТОР: разбор под образец-разговор с формулой самопроверки курса.",
        },
        {
          ...
          answer: [1, 3, 0, 2],
          hint: "ПИШЕТ РЕДАКТОР: подсказка к сборке строки о соке.",
          why: "ПИШЕТ РЕДАКТОР: разбор называет собранную строку о соке.",
        },
      ],
    },
  ],
   ...
   * строкой о себе (`short`, вопрос 2); записать одно слово с новой записи
    ...
    questions: [
      {
        ...
        outcome: "говорить, что бывает всегда и что иногда: I always work",
        prompt:
          "ПИШЕТ РЕДАКТОР: условие говорит, что Нурлан хотел написать «Я иногда читаю газету», а " +
      ...
      },
      {
        ...
        outcome: "называть среднюю частоту словами usually и often",
        prompt:
          "ПИШЕТ РЕДАКТОР: условие: друг спрашивает Do you often swim in the evening?; ответить по-английски " +
          "строкой о себе, в которой будет слово «обычно».",
        ...
        why: "ПИШЕТ РЕДАКТОР: разбор называет верную строку и место usually перед глаголом; порядок Usually I… не называет.",
      },
      {
        /*
      ...
      },
      {
        ...
        outcome: "спрашивать о частоте вопросом с do",
        prompt:
          "ПИШЕТ РЕДАКТОР: условие говорит, что Ким спросил Дану Do your parents cook fish?, а хотел " +
          "узнать, часто ли её родители готовят рыбу, и просит переписать вопрос так, чтобы в нём " +
          "было «часто».",
      ...
      },
      {
        ...
        outcome: "находить в записи, что человек делает всегда, а что иногда",
        prompt:
          "ПИШЕТ РЕДАКТОР: условие печатает запись Кима «I always eat at school. Sometimes I watch television in " +
          "the afternoon. I often go to the park.» и спрашивает, как часто Ким смотрит телевизор днём.",
        options: [
          { text: "всегда" },
          { text: "иногда", correct: true },
          { text: "часто" },
        ],
        why: "ПИШЕТ РЕДАКТОР: разбор называет строку записи о телевизоре.",
      },
      {
        /*
        ...
        prompt:
          "ПИШЕТ РЕДАКТОР: условие спрашивает, как часто он поёт, и просит записать слово, которое звучит " +
          "после every.",
        answer: "day",
        accept: ["every day"],
      ...
      },
      {
        ...
        outcome: "говорить, что бывает всегда и что иногда: I always work",
        prompt:
          "ПИШЕТ РЕДАКТОР: условие: ученик хотел сказать «Они всегда спят днём» и написал They always in the " +
          "afternoon sleep. Спрашивает, почему это ошибка.",
        options: [
          { text: "always должно стоять в конце строки" },
          { text: "перед always не хватает формы are" },
          { text: "оборот in the afternoon должен стоять после глагола sleep", correct: true },
        ],
        why: "ПИШЕТ РЕДАКТОР: разбор называет верную строку и место оборота о времени.",
      },
    ],
  },
};
