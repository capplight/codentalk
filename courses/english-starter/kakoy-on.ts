...
const module: Module = {
      ...
      blocks: [
        ...
        },
        {
          ...
          explain:
            ...
            "Слово but соединяет два прилагательных, которые спорят друг с другом: старая, но " +
            "хорошая.",
        },
        {
        ...
        },
        {
          ...
          tone: "info",
          text:
            "Цвет ставят отдельной строкой, а не рядом с остальным. «It is old and black» " +
            "сказать можно, но читающий ищет цвет глазами — и находит быстрее, когда тот " +
            "стоит сам по себе.",
        },
        ...
        // ---- задания ----
        {
          ...
          kind: "choice",
          prompt:
            "Человек написал объявление: «This is bike. It is new. It is green.» " +
            "Что потеряно в первой строке?",
          options: [
            { text: "Форма be" },
            { text: "Артикль", correct: true },
            { text: "Цвет" },
          ],
          hint: "Сравни первую строку с образцом: чего в ней не хватает перед словом bike?",
          why:
            "This is a bike. Форма be на месте — is стоит. Цвет назван в третьей строке. " +
            "Не хватает артикля перед названием вещи.",
        },
        {
  ...
  quiz: {
    ...
    questions: [
      ...
      // артикль во второй строке, где после is идёт прилагательное, а не название.
      {
      ...
      outcome: "проверять объявление о вещи: артикль в первой строке и форма be во всех",
        prompt:
          "Объявление: «This is a bike.» / «It is a new.» / «It is green.» " +
          "В какой строке слово лишнее?",
        options: [
          { text: "В первой" },
          { text: "Во второй", correct: true },
          { text: "Лишнего нет" },
        ],
        hint: "Артикль ставят перед названием вещи. New — название вещи или прилагательное?",
        why:
          "It is new. Артикль идёт перед названием вещи, а new — прилагательное, и ему " +
          "артикль не нужен. В первой строке a стоит верно: там название.",
      },
    ],
  },
};
