...
const module: Module = {
  ...
  outcomes: [
    ...
    "проверять объявление о вещи: артикль в первой строке и форма be во всех",
  ],
  ...
  lessons: [
    ...
    // =====================================================================
    {
      ...
      title: "Пишем объявление о вещи",
      estimatedMinutes: 12,
      // Итог назван по той половине, которую проверяет работа: письмо машина
      // не оценивает. То же решение, что в модуле 3.
      outcome: "проверять объявление о вещи: артикль в первой строке и форма be во всех",
      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "Объявление о вещи пишут коротко: читать его будут глазами, наспех, среди " +
              "десятка других.",
            "Поэтому в нём три вещи и ни одной лишней: что это, какое оно и какого цвета. " +
              "Всё остальное отнимает у читающего время.",
          ],
        },
        {
          id: "obrazec-obyavleniya",
          kind: "example",
          caption: "Объявление из трёх строк",
          ...
          explain:
            "Первая строка называет вещь, вторая говорит, какая она, третья — цвет. " +
            "Слово but соединяет два предложения, которые спорят друг с другом: «она " +
            "старая» и «она очень хорошая». Так же оно объяснено в уроке об объявлении.",
        },
        {
        ...
        },
        {
          ...
          kind: "essay",
          prompt:
            "Напиши объявление о своей вещи тремя строками: что это, какая она, какого " +
            "цвета.",
          minWords: 9,
          sample: "This is a bike. It is old but it is very good. It is green.",
          checklist: [
            "В первой строке есть a или an перед названием вещи.",
            "В каждой строке стоит форма be: is или it's.",
            "Во второй строке названо прилагательное: new, old, big, expensive.",
            "В третьей строке назван цвет.",
          ],
          hint:
            "Возьми три строки образца и подставь своё: This is a … . It is … . It is … .",
          why:
            "Сравни свой ответ с образцом по четырём пунктам выше. Вещь, прилагательное и цвет " +
            "у каждого свои. Важно другое: артикль стоит только в первой строке, а форма " +
            "be — во всех трёх.",
        },
      ],
    },
