...
const module: Module = {
  ...
  sources: [
    ...
    },
    {
      ...
      section:
        "УРОК ПИСЬМА «Пишем объявление о вещи». с. 67, шкала Creative writing, графа A1, дословно: «Can use simple words/signs and phrases to describe certain everyday objects (e.g. the colour of a car, whether it is big or small)». Источник называет прямо и цвет, и размер — оба урока модуля. " +
        "Там же, с. 66, шкала Overall written production, графа A1: «Can produce simple isolated phrases and sentences» — объявление из трёх отдельных строк это и есть. " +
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Читать его будут глазами, наспех, среди десятка других. Поэтому в нём " +
              "заголовок и три коротких строки: что продаётся и какое оно, какого цвета " +
              "и за сколько.",
          ],
        },
        {
          ...
          explain:
            ...
            "предложения, которые спорят друг с другом: «он старый» и «он дешёвый».",
        },
        {
        ...
        },
        {
          ...
          text:
            ...
            "описании предмета цвет стоит рядом: It's black and very big.",
        },
        ...
        // ---- задания ----
        {
          ...
          options: [
            ...
            { text: "This is a camera.", correct: true },
            { text: "This is green camera." },
          ],
          hint: "Проверь в каждой строке два места: форму be и артикль перед названием.",
          why:
            "This is a camera. В первой строке потеряна форма be, в третьей — артикль " +
