    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          kind: "speak",
          prompt: "Произнеси вслух вопрос о ручке и ответ на него.",
          phrase: "Have you got a pen? — Yes, I have.",
          translation: "У тебя есть ручка? — Да.",
          hint: "В вопросе голос к концу идёт вверх.",
          why:
            "Сначала спрашивают, есть ли вещь, и только потом просят её."
            ,
        },
      ],
    },
    ...
    questions: [
      ...
      },
      {
        ...
        why:
          ...
          "о принадлежности: место у них одно, и вдвоём они на нём не помещаются.",
      },
      {
        id: "q-dopisat-tvoy",
        kind: "gap",
