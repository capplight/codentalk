  ...
  sources: [
    ...
    },
    {
      ...
      section:
        ...
        "ПОРОГ В ДВЕНАДЦАТЬ СЛОВ — НАШ, а не из источника: четыре коротких предложения короче не выходят. Счёт слов задают руководства Cambridge, и только со ступени выше нашей — см. отдельную запись об A2 Key ниже.",
