...
const module: Module = {
  ...
  sources: [
    ...
    },
    {
      ...
      section:
        ...
        "ближайшее — набор A2 в cambridge-vocab-a2-key.pdf, с. 24. Пять стран урока 2 — " +
        "выбор автора, а не выписка из источника",
  ...
  lessons: [
      ...
      blocks: [
        {
          ...
          text: [
            "Названия стран и городов по-английски пишутся не так, как звучат по-русски, и " +
              ...
              "Spain, Италия — Italy.",
            "Правило написания при этом одно и уже знакомо по модулю про алфавит: всякое " +
              "название страны и города пишется с заглавной буквы, где бы оно ни стояло.",
          ],
        },
        {
          id: "tablica-stran",
    ...
    {
      slug: "artikl-a-an",
      title: "Слово a перед названием предмета",
      estimatedMinutes: 15,
      ...
      blocks: [
        {
          ...
          text: [
            "В английском перед названием предмета или занятия обычно стоит маленькое " +
              "слово a: a city, a street, a doctor. По-русски ему ничего не соответствует, " +
              "и перевести его отдельно нельзя — оно значит примерно «один из таких».",
            "Пропускать его нельзя: «I'm doctor» для английского уха звучит так же " +
              "неправильно, как «я есть врачом» для русского. Правильно — I'm a doctor.",
          ],
        },
        {
          id: "a-ili-an",
          ...
          text: [
            ...
            "Мерка тут по звуку, а не по букве. Если слово начинается с гласного звука, " +
        ...
        },
        {
          ...
          tone: "info",
          text:
            "Перед именем, названием страны и города слово a не ставят: I'm Alim, " +
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          tone: "info",
          text:
            "Многие названия занятий в английском годятся и мужчине, и женщине: teacher — " +
            "и преподаватель, и преподавательница; doctor — врач и о мужчине, и о женщине. " +
            "Но так не со всеми: у actor есть пара actress — о женщине. " +
        ...
        },
        {
          ...
          why: "I'm a teacher. Мерка та же, что и во всех предложениях этого модуля.",
        },
        {
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Обрати внимание на порядок: в утверждении было you are, а в вопросе части " +
              "поменялись местами — are you. Разбирать это устройство сейчас не нужно, " +
              "оно ждёт своего модуля; выучи вопрос целиком, как оборот How do you spell " +
              "that? из модуля про алфавит.",
          ],
        },
        {
          id: "tablica-voprosov",
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Все четыре предложения построены по одному образцу, разобранной в этом модуле: " +
        ...
        },
        {
          ...
          text:
            ...
            "слово a перед занятием. «I from Almaty», «I'm student» — обе ошибки из этого " +
  ...
  quiz: {
    ...
    questions: [
      ...
      },
      {
        ...
        why: "I'm a student. Нужны и форма be, и слово a перед занятием: «I student» без глагола, «Am a student» без того, о ком речь.",
      },
      {
        id: "q-predlog-gde",
        kind: "gap",
      ...
      },
      {
        ...
        why:
          "«I from Spain» — нет формы be. «I'm teacher» — нет слова a перед занятием.",
      },
      {
