  ...
  quiz: {
    ...
    questions: [
      ...
      },
      {
        ...
        kind: "choice",
        outcome: "спрашивать о другом человеке: Does he work here?",
        // Первая правка взяла верный вариант дословно из условия урочного задания
        // («окончание стоит дважды»), а подсказка называла ответ. Нашёл методист.
        // Теперь спрашивают, что делать с глаголом.
        prompt: "Ученик написал: Does she lives in Astana? Что надо сделать с глаголом?",
        options: [
          { text: "Поставить его перед Does." },
          { text: "Убрать у него окончание -s.", correct: true },
          { text: "Заменить Does на Do." },
        ],
        hint: "Сравни строку с рассказом: She lives in Astana.",
        why:
          "Убрать окончание -s: Does she live in Astana? Оно уже внутри Does, и " +
          "глаголу не достаётся. Слово Do здесь не годится — речь об одном другом " +
          "человеке.",
      },
      ...
      // ---- итог 4 ----
      {
        ...
        kind: "short",
        outcome: "различать вопрос с формой be и вопрос с do: Are you a doctor? — Do you work?",
        // «Are you a doctor?» — сквозной пример модуля, он стоит в нём тринадцать
        // раз. Умение то же, занятие другое: этой строки в модуле нет нигде.
        prompt: "Ты хочешь спросить, водитель ли собеседник. Запиши вопрос целиком.",
        answer: "Are you a driver?",
        accept: ["Are you a driver"],
        hint: "Спрашивают не о деле, а о том, кто человек.",
        why: "Are you a driver? Названию человека нужна форма be, а do спрашивает о действии.",
      },
      {
