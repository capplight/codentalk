      ...
      blocks: [
        ...
        },
        {
          ...
          text:
            ...
            "нужны особые формы чисел, вроде «пятое» вместо «пять». Пока называй месяц " +
            "целиком: My birthday is in May.",
        },
  ...
  quiz: {
    ...
    questions: [
      ...
      },
      {
        ...
        kind: "short",
        outcome: "называть половину и четверть часа",
        prompt: "На часах 7:30. Запиши тремя словами: два слова и название часа.",
