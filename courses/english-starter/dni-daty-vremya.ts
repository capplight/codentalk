...
const module: Module = {
  ...
  sources: [
    {
      ...
      section:
        "УРОК ПИСЬМА «Пишем сообщение о встрече». с. 83, шкала Correspondence, графа A1, дословно: «Can compose a short, very simple message (e.g. a text message) to friends to give them a piece of information or to ask them a question». Сообщение о встрече — и сведение, и вопрос сразу; жанр назван источником прямо. " +
        "Там же, с. 55, шкала Reading correspondence, графа A1, о том же жанре с другой стороны: «Can understand short, simple messages sent via social media or e-mail (e.g. proposing what to do, when and where to meet)» — «when and where to meet» и есть содержание этого сообщения. " +
        "ОГОВОРКА О СОСЕДНЕЙ ГРАФЕ: с. 68, шкала Reports and essays, графы A1 и Pre-A1 — «No descriptors available». " +
        "ПОРОГ В ДВЕНАДЦАТЬ СЛОВ — НАШ: столько выходит в трёх коротких строках, которых требует условие. Порог взят по условию, а не по образцу, чтобы не отсекать короткий верный ответ. " +
  ...
  outcomes: [
    ...
    "проверять в сообщении о встрече предлог перед днём и перед временем",
  ],
  ...
  lessons: [
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Все семь кончаются одинаково — на day, «день». Запоминать нужно только " +
              "начало слова.",
            "Семь дней вместе — это week, неделя: this week — на этой неделе.",
          ],
        },
        {
          id: "tablica-dney",
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Сам месяц по-английски — month: this month — в этом месяце.",
          ],
        },
        {
          id: "tablica-mesyacev",
        ...
        },
        {
          ...
          //
          // Было «прочитать её вслух — пока нет»: слово «пока» обещало урок,
          // которого в курсе не существует ни в одном из двадцати пяти модулей.
          // Ученик оставался ждать его до конца ступени. Нашёл методист
          // 1 сентября 2026. Теперь сказан факт об английском, а не обещание.
          text:
            "Записать дату ты уже можешь. Вслух её называют иначе — особыми формами " +
            "чисел, вроде «пятое» вместо «пять». Называй месяц целиком: My birthday " +
            "is in May.",
        },
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Про день говорят today — сегодня, а про следующий tomorrow — завтра.",
          ],
        },
        {
          id: "tablica-chasov",
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Сама минута по-английски — minute: five minutes — пять минут.",
          ],
        },
        {
          id: "tablica-polovin",
        ...
        },
        {
          ...
          explain:
            "Half past six — это 6:30. A quarter to seven — 6:45: дословно «четверть до " +
            "семи», по-русски — «без четверти семь». " +
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          explain:
            "По-русски разницы не видно вовсе: и там и там просто «встреча». " +
            "Английскому нужно короткое слово впереди.\n\n" +
            "В первой строке встреча названа впервые — a meeting. Во второй собеседник " +
            "спрашивает уже о ней же, поэтому the meeting.\n\n" +
            "Вопрос построен перестановкой, как в модуле «Вопрос и краткий ответ».",
        },
    ...
    // =====================================================================
    // Урок письма. Здесь ученик впервые пишет ПИСЬМО — короткое сообщение
    // другому человеку, а не рассказ о себе. Источник называет этот жанр
    // прямо, шкала Correspondence; опора в `sources`.
    //
    // Итог назван по той половине, которую проверяет работа: письмо машина
    // не оценивает.
    // =====================================================================
    {
      slug: "pishem-soobshchenie-o-vstreche",
      title: "Пишем сообщение о встрече",
      estimatedMinutes: 12,
      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "Договориться о встрече чаще пишут, чем говорят: сообщение можно перечитать, " +
              "а сказанное вслух собеседник запомнит не всё.",
            "Поэтому в сообщении называют три вещи: день, время и часть суток. Это те же " +
              "три, что в уроке «Договориться о встрече». Пропустишь одну — придётся " +
              "писать второе сообщение.",
          ],
        },
        {
          ...
          // Места в сообщении нет нарочно. Предлог at в этом модуле значит одно —
          // «в такое-то время»; at места идёт в модуле 12, и «at the school» здесь
          // сбивало бы. Ровно это уже снимали из урока 9 по разбору методиста, а
          // урок письма вернул. Слова school в модуле тоже ещё нет.
          text:
          ...
          explain:
            "Первая строка спрашивает, свободен ли собеседник, вторая называет время и " +
            "часть суток, третья прощается и повторяет день. Перед днём стоит on, перед " +
            "часом — at, перед частью суток — in.",
        },
        {
          id: "predlogi-v-soobshchenii",
          kind: "note",
          tone: "mistake",
          text:
            "Здесь путают предлоги. «In Friday» и «on six» по-английски не читаются. " +
            "Перед днём недели стоит on, перед часом — at, перед частью суток — in.\n\n" +
            "У последнего есть исключение, разобранное в уроке о частях суток: at night, " +
            "а не in the night. Проверяй сообщение по этим четырём случаям.",
        },
        {
          id: "chego-ne-hvataet-bez-vremeni",
          kind: "note",
          tone: "info",
          text:
            "Сообщение без времени собеседник дочитает и переспросит: «What time?» Это " +
            "не ошибка языка, а потерянный день — ответ придёт не сразу.",
        },

        // ---- задания ----
        {
          // Случай взят не тот, что разобран во врезке выше («In Friday» и
          // «on six»): иначе ответ читается из врезки, а не из строки.
          // Нашёл методист.
          id: "z1-kakoy-predlog-poteryan",
          kind: "choice",
          prompt: "В какой строке сообщения предлог стоит верно?",
          options: [
            { text: "The lesson is on seven." },
            { text: "See you at Monday!" },
            { text: "I am free in the morning.", correct: true },
          ],
          hint: "Проверь каждую строку: с чем идёт at, с чем on, а с чем in.",
          why:
            "I am free in the morning. Часть суток идёт с in. В первой строке нужен at " +
            "(час), во второй — on (день недели).",
        },
        {
          id: "z2-ispravit-predlog",
          kind: "short",
          prompt: "Исправь и запиши предложение целиком: «The lesson is on six.»",
          answer: "The lesson is at six.",
          exact: true,
          accept: ["The lesson is at six"],
          hint: "Перед часом ставят at.",
          why:
            "The lesson is at six. Предлог on идёт с днём недели и с датой, а перед " +
            "точным временем — at.",
        },
        {
          // Порог в двенадцать слов — наш: столько выходит в трёх коротких
          // строках, которых требует условие. Образец длиннее, и порог нарочно
          // взят по условию, а не по образцу.
          id: "z3-napisat-soobshchenie",
          kind: "essay",
          prompt:
            "Напиши сообщение о встрече тремя строками: спроси, свободен ли собеседник " +
            "в какой-то день, назови время и часть суток, попрощайся, повторив день.",
          minWords: 12,
          sample:
            "Hi! Are you free on Monday? The meeting is at five in the evening. " +
            "See you on Monday!",
          checklist: [
            "Перед днём недели стоит on.",
            "Перед часом стоит at.",
            "Перед частью суток стоит in: in the morning, in the evening. Ночь — " +
              "исключение: at night.",
            "День недели написан с заглавной буквы.",
          ],
          hint:
            "Возьми три строки образца и подставь своё: Are you free on … ? … is at … . " +
            "See you on … !",
          why:
            "Сравни свой ответ с образцом по четырём пунктам выше. День, время и часть " +
            "суток у каждого свои. Важно другое: каждому из трёх идёт свой предлог, и по " +
            "ним сообщение и проверяют.",
        },
      ],
    },
  ],
  ...
  quiz: {
    ...
    questions: [
      ...
      },
      {
        ...
        kind: "short",
        outcome: "говорить, который час: It's seven o'clock",
        // Было «На часах 11:00» при «10:00» в задании урока — сменён только час.
        prompt:
          "Собеседник спросил «What time is it?» и услышал «It's eleven.» Запиши ответ целиком, как принято.",
      ...
      },
      {
        ...
        kind: "short",
        outcome: "называть половину и четверть часа",
        // Было «На часах 7:30» при «9:30» в задании урока — сменён только час.
        prompt:
          "Ученик написал про 7:30: «It's half to eight.» Запиши время без ошибки, тремя словами.",
        answer: "half past seven",
        accept: ["Half past seven", "It's half past seven.", "It's half past seven"],
        why:
          "Half past seven. По-русски это «полвосьмого», а по-английски называют час, " +
      ...
      },
      {
        ...
        kind: "choice",
        outcome: "называть половину и четверть часа",
        // Было «На часах 8:45» при «5:45» в задании урока, и ответ `to` совпадал
        // дословно: ученик вставлял слово по памяти. Теперь спрашивается сам
        // случай, а не пропущенное слово.
        prompt: "Когда перед названием часа говорят to, а не past?",
        options: [
          { text: "Когда минуты ещё остались до этого часа.", correct: true },
          { text: "Когда минуты уже прошли после этого часа." },
          { text: "Когда час ровный, без минут." },
        ],
        why:
          "To — когда минуты остались до часа: a quarter to nine, без четверти " +
          "девять. Past — когда они прошли после него: half past six.",
      },
      {
      ...
      },
      {
        ...
        outcome: "договариваться о встрече: называть день, время и часть суток",
        prompt: "Расставь реплики разговора по порядку.",
        // Прежний разговор допускал два разумных порядка: реплика «In the
        // evening.» одинаково ложилась и после вопроса о времени, и в конец, а
        // засчитывался один. Ученик отвечал верно и читал «пока не так».
        // Здесь порядок задан смыслом: вопрос, поправка, согласие.
        items: [
          "No, it's on Wednesday.",
          "Is the lesson on Tuesday?",
          "OK, see you on Wednesday!",
        ],
        answer: [1, 0, 2],
        why:
          "Is the lesson on Tuesday? — No, it's on Wednesday. — OK, see you on Wednesday! " +
          "Сначала вопрос, потом поправка, потом согласие. Перед днём недели везде стоит on.",
      },
      {
      ...
      // ---- письмо -----------------------------------------------------
      // Угол другой, чем в уроке и чем у соседнего вопроса. В уроке разбирают
      // одно неверное предложение; сосед просит собрать верное целиком. Здесь
      // в сообщении три предлога, два верны, и надо найти третий.
      {
        id: "q-najti-neverny-predlog",
        kind: "hottext",
        outcome: "проверять в сообщении о встрече предлог перед днём и перед временем",
        prompt: "Отметь в сообщении предлог, который стоит неверно.",
        // Отмечают предлог вместе со словом, к которому он идёт: голое «in»
        // встретилось бы в задании дважды, и нажать было бы не на что —
        // проверка это ловит.
        // Третья запись — исключение at night, разобранное в уроке о частях
        // суток. Отметить её было бы ошибкой: она верна. Соседний вопрос
        // `q-oshibka-v-predloge` берёт отдельные записи, здесь же предлоги
        // стоят внутри сообщения — и одно из них исключение.
        parts: [
          { text: "Are you free " },
          { text: "on Friday", selectable: true },
          { text: "? The lesson is " },
          { text: "in six ", selectable: true, correct: true },
          { text: "at night", selectable: true },
          { text: "." },
        ],
        hint: "Три предлога, и каждый идёт со своим: день, час, часть суток.",
        why:
          "Перед часом ставят at: at six. Запись at night верна — это исключение из " +
          "урока о частях суток. On перед днём недели тоже верно.",
      },
    ],
  },
};
