      ...
      blocks: [
        ...
        },
        {
          ...
          hint:
            ...
            "See you at … !",
          why:
            "Сравни свой ответ с образцом по четырём пунктам выше. День, время и место " +
            "у каждого свои. Важно другое: каждому из трёх идёт свой предлог, и по ним " +
            "сообщение и проверяют.",
        },
      ],
    },
  ],
