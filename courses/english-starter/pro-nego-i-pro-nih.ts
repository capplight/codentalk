...
const module: Module = {
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "У look предлог есть и по-русски: «смотрю на картинку». В английском, когда " +
              "говоришь, на что смотришь, ставят at: I look at the picture.",
          ],
        },
        {
  ...
  quiz: {
    ...
    questions: [
      ...
      {
        // Задание урока 5 отличалось от прежнего вопроса одним местоимением при том
        // же наборе ошибок. Теперь спрашивают не «где нет ошибки», а что в строке
        // не так. Третий отвлекающий был выдуман — ошибок с артиклем перед
        // предлогом не бывает; нашёл методист.
        id: "q-chto-ne-tak-posle-predloga",
        kind: "choice",
        outcome: "ставить слово после предлога: This is for me",
        prompt: "Ученик написал: I work with she. Что в этой строке не так?",
        options: [
          { text: "Глагол должен стоять в конце: I with her work." },
          { text: "После предлога местоимение стоит в другой форме — her.", correct: true },
          { text: "Ничего: строка верна." },
        ],
