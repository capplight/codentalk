  ...
  sources: [
    {
      ...
      section:
        ...
        "придаточным — пример источника «I don't remember the title but it's very boring!». Урок " +
  ...
  quiz: {
    ...
    questions: [
      ...
      },
      {
        ...
        kind: "choice",
        outcome: "говорить, чего не делает другой человек: He doesn't work on Sunday",
        // Задание урока 2 отличалось от прежнего вопроса одним словом — сестра
        // вместо брата — при том же наборе ошибок. Первая правка сделала из него
        // вопрос «почему», но верный вариант списала у урока, а отвлекающего
        // «doesn't идёт только с I и you» такой ошибки не бывает: ошибаются в
        // обратную сторону, He don't. Нашёл методист.
        prompt:
          "В строке He doesn't works on Sunday окончание -s стоит в двух местах. Где " +
          "оно лишнее?",
        options: [
          { text: "В слове doesn't." },
          { text: "В слове works.", correct: true },
          { text: "Лишнего нет: так и пишут." },
        ],
        hint: "Одно из двух мест — само слово отрицания, и там окончание своё.",
        why:
          "В слове works. Окончание уже внутри doesn't, поэтому глагол остаётся без " +
          "него: He doesn't work on Sunday.",
      },
      {
