 ...
 *
 * 1. Звук есть: синтез речи Azure, британские голоса — решение владельца
 *    16 августа 2026 (docs/zadachi-vladeltsa.md, п. 1.4). Произношение вдобавок
 *    дано международной транскрипцией, британская норма: запись показывает, как
 *    звучит, а транскрипция — из чего это звучание сложено.
 *
 ...
 *
 * 3. Уроков десять: восемь по программе плюс урок слушания и урок чтения,
...
const module: Module = {
  ...
  sources: [
    {
      ...
      section:
        ...
        "Там же, с. 54, шкала Overall reading comprehension, графа A1: «Can understand very short, simple texts a single phrase at a time, picking up familiar names, words and basic phrases and rereading as required» — «a single phrase at a time» и есть чтение по строкам, а перечитывание урок прямо предлагает при счёте очерёдности. " +
        "ЧЕГО В ИСТОЧНИКЕ НЕТ: он не говорит, как в переписке помечают говорящего. Тире перед репликой — наша разметка, принятая во всех текстах курса. Урок объясняет её первой же строкой объяснения: без этого счёт очерёдности не на чем строить. " +
  ...
  outcomes: [
    ...
    "понимать по переписке, кто что сказал",
  ],
      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "В английском два повседневных приветствия: hello и hi. Они значат одно и " +
              "то же. Начни с любого.",
          ],
        },
        {
          id: "chtenie-hello",
      ...
      blocks: [
        {
          ...
          text: [
            "Чтобы назвать себя, по-английски говорят I am и своё имя: I am Alim. " +
              "Слово I — «я». Второе слово, am, бывает только с I и больше ни с чем. Что это за слово, разберём в этом же модуле, в уроке про am, is и are.",
        ...
        },
        {
          ...
          items: [
            ...
            { term: "am", translation: "есть (только с I)", example: "I am here.", hint: "/æm/" },
        ...
        },
        {
          ...
          translation: "Здравствуй! Я ... . Приятно познакомиться.",
      ...
      blocks: [
        ...
        },
        {
          ...
          perevod: {
            ...
            "— I am fine, thank you. Dana and Aigul are fine too.":
              "Хорошо, спасибо. У Даны и Айгуль тоже всё хорошо.",
          },
          explain:
            "Are — потому что you. Am — потому что I.\n\n" +
            "Are во второй раз — потому что речь о двоих: Dana and Aigul. Это те же " +
            "«они», that is they.\n\n" +
            "Вместо местоимения в начале часто стоят имена: Dana is a teacher, Dana " +
            "and Aigul are teachers. Форму выбирает то, о ком речь, — один это " +
      ...
      blocks: [
        ...
        },
        {
          ...
          explain:
            ...
            "формой be. Кроме одной: у этой строки по-русски говорят просто «всё " +
            "нормально», без местоимения.",
        },
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Молча кивнуть — худший выход: собеседник продолжит, а нить уже потеряна. " +
              "Три коротких фразы решают дело, и первая из них — Sorry?",
          ],
        },
        {
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          translation: "Здравствуй! Я ... . Приятно познакомиться. Как дела? ... До свидания!",
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Зато порядок реплик обычно один и тот же, и по нему понятно, что прозвучит " +
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Каждая строка начинается с тире: так помечено, что заговорил другой.",
  ...
  quiz: {
    ...
    questions: [
      ...
      {
        id: "q-ispravit-mestoimenie",
        kind: "short",
        outcome: "ставить местоимение перед глаголом: I, you, he, she, it, we, they",
        prompt:
          "Ученик написал: «Nurlan is a teacher. She is from Astana.» " +
          "Запиши вторую строку без ошибки.",
        answer: "He is from Astana.",
        exact: true,
        accept: ["He is from Astana", "He's from Astana.", "He's from Astana"],
        why:
          "He is from Astana. Речь о Нурлане, а she говорят о женщине. Первая строка " +
          "уже назвала, о ком речь, — вторая должна с ней сойтись.",
      },
      {
        id: "q-napisat-my-celikom",
        kind: "short",
        outcome: "ставить местоимение перед глаголом: I, you, he, she, it, we, they",
        prompt: "Ты говоришь о себе и о Дане одним словом. Запиши предложение целиком: «Мы Алим и Дана».",
        answer: "We are Alim and Dana.",
        exact: true,
        accept: [
          "We are Alim and Dana",
          "We're Alim and Dana.",
          "We're Alim and Dana",
        ],
        why:
          "We are Alim and Dana. Местоимение открывает предложение и потому берёт " +
          "заглавную, а форма are — потому что нас двое.",
      },
      {
        id: "q-forma-be-they",
        kind: "choice",
      ...
      {
        id: "q-najti-nevernuyu-formu",
        kind: "hottext",
        outcome: "выбирать am, is или are по слову перед глаголом",
        prompt: "В одной строке форма be выбрана неверно. Отметь эту строку.",
        parts: [
          { text: "I am Alim.", selectable: true },
          { text: " · " },
          { text: "She are OK.", selectable: true, correct: true },
          { text: " · " },
          { text: "They are here.", selectable: true },
        ],
        why:
          "«She are OK» — с he, she и it идёт форма is: She is OK. В двух других " +
          "строках формы стоят верно.",
      },
      {
      ...
      {
        // Дважды чинилось заменой имени — и порода оставалась: рамка урочного
        // задания та же, ответ тот же, и помнящий урок вписывает am не разбирая.
        // Методист: чинить надо не третьей заменой слова, а сменой ВИДА.
        id: "q-am",
        kind: "short",
        outcome: "называть своё имя и понимать, когда имя спрашивают",
        prompt: "Ученик написал: I Alim. Запиши строку без ошибки.",
        answer: "I am Alim.",
        accept: ["I am Alim", "I'm Alim.", "I'm Alim"],
        hint: "По-русски глагол здесь не нужен, по-английски нужен.",
        why:
          "I am Alim. Годится и короткая запись I'm. По-русски говорят «я Алим» без " +
          "глагола, и потому его легко потерять.",
      },
      {
        id: "q-vopros-imya",
        kind: "choice",
