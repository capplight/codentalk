    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          tone: "mistake",
          text:
            "Good evening и good night похожи, а роли у них противоположные: good evening — " +
            "при встрече, good night — при расставании. Перепутать их легко, поэтому " +
            "стоит запомнить пару целиком.",
        },
        {
          id: "proshchanie",
          kind: "explain",
      ...
      blocks: [
        {
          ...
          text: [
            "Чтобы назвать себя, по-английски говорят I am и своё имя: I am Alim. " +
              "Слово I — «я», am — форма глагола be, которая идёт только со словом I. Ни с " +
              "каким другим словом am не сочетается.",
        ...
        },
        {
          ...
          text: [
            ...
            "Полное I am оставляют там, где сказанное выделяют голосом: I am Alim — «это именно " +
              "я Алим». В обычном разговоре это звучит слишком твёрдо, поэтому говори I'm.",
          ],
        },
        {
          id: "net-ty-i-vy",
        ...
        },
        {
          ...
          tone: "mistake",
          text:
            "Ловушка на письме: I всегда пишется заглавной буквой, где бы ни стояло в " +
            "предложении. Это единственное местоимение с таким правилом. В модуле про " +
            "алфавит с заглавной писались имена, страны и языки — здесь к ним добавляется " +
            "слово, которое требует заглавной само по себе.",
        },
        {
          id: "vopros-imya",
          kind: "explain",
      ...
      blocks: [
        ...
        },
        {
          ...
          text:
            ...
            "формы сейчас не нужно: выучи вопрос целиком, а устройство разберём в модуле, " +
