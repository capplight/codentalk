    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          tone: "mistake",
          text:
            "Здесь some идёт с несколькими предметами, и форма be при нём — are.\n\n" +
      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "Ты в чужом городе и ищешь магазин. Спросить Where is the shop? можно — " +
              "этому учил модуль «Где это». Но такой вопрос спрашивает, ГДЕ магазин, " +
              "и годится, когда ты уже знаешь, что он здесь есть.",
            "А когда не знаешь, спрашивают о другом: есть ли здесь магазин вообще. " +
              "По-английски — Is there a shop near here?",
  ...
  quiz: {
    ...
    questions: [
      ...
      },
      {
        ...
        kind: "short",
        outcome: "рассказывать о своём жилье четырьмя предложениями",
        // Было «три комнаты» при «двух» в задании урока — сменено числительное,
        // а рамка, вид задания и зачин остались те же. Нашёл методист.
        prompt:
          "Ученик написал вторым шагом рассказа: «There is three rooms.» Запиши строку без ошибки.",
        answer: "There are three rooms.",
        exact: true,
        accept: ["There are three rooms"],
        why:
          "There are three rooms. Комнат несколько, значит форма are, а не is.",
      },
      {
