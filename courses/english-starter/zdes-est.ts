...
const module: Module = {
  ...
  outcomes: [
    ...
    "находить в описании жилья потерянное there и форму be не по числу",
  ],
  ...
  lessons: [
    ...
    // =====================================================================
    {
      ...
      estimatedMinutes: 12,
      outcome: "находить в описании жилья потерянное there и форму be не по числу",
      ...
      blocks: [
        ...
        },
        {
          ...
          checklist: [
            ...
            "Перед названием ОДНОЙ вещи стоит a или an. Там, где вещей несколько, " +
              "артикля нет: There are three rooms.",
