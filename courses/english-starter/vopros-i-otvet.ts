    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          explain:
            "Мерка одна для всех: что стоит первым, уходит на второе место, а глагол " +
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          tone: "info",
          text:
            "В коротком ответе короткую форму не ставят: «Yes, I'm» сказать нельзя, только " +
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          tone: "mistake",
          text:
            "У первого лица короткая форма только одна: No, I'm not. Слова «amn't» в " +
      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "Формы be в вопросе те же, что и в сообщении: am — с I; is — с he, she, it; " +
              "are — с you, we, they. Меняется только их место: они выходят вперёд.",
        ...
        },
        {
          ...
          tone: "info",
          text:
            "Строка с Am I…? стоит в таблице не для полноты: вопрос «Am I right?» — " +
            "«я прав?» — пригодится всякому, кто учит язык и хочет проверить себя.",
        },
        {
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          tone: "mistake",
          text:
            "В вопросе слово a никуда не девается: «Is he a doctor?», а не «Is he doctor?». " +
        ...
        // ---- задания ----
        {
          ...
          why: "Is he a driver? Слово a осталось на месте.",
        },
        {
      ...
      blocks: [
        {
          ...
          text: [
            "По-русски вопрос от сообщения часто отличает только голос: «ты студент» и " +
              "«ты студент?» состоят из одних и тех же слов в одном порядке.",
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          why: "Are you a teacher? Форма are идёт с you, слово a перед занятием обязательно.",
        },
        {
