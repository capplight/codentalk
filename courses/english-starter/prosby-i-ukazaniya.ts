  ...
  quiz: {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { text: "Вежливое слово: его место в конце.", correct: true },
        ...
        why:
          "Вежливое слово. В середине оно разделяет действие и дверь, а его место — " +
          "в конце: Open the door, please.",
      },
      {
        id: "q-please-napisat",
        kind: "short",
      ...
      // ---- итог 4 ----
      {
        ...
        id: "q-pochemu-prosba-myagche",
        kind: "choice",
        outcome: "просить: Can you help?",
        prompt: "Почему «Can you wait, please?» звучит мягче, чем «Wait!»?",
        options: [
          { text: "Она короче." },
          { text: "Это вопрос, и человек волен ответить.", correct: true },
          { text: "В ней нет глагола." },
        ],
        hint: "Посмотри на знак в конце строки.",
        why:
          "Это вопрос. Указание не оставляет выбора, а вопросом человека спрашивают, " +
          "и он может согласиться или нет.",
      },
      {
        id: "q-prosba-vybor",
        kind: "choice",
