      ...
      blocks: [
        ...
        },
        {
          ...
          text: [
            ...
            "Значит и запоминать тут нечего: выучил один раз — годится для всех.",
          ],
        },
        {
          id: "ne-cans",
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Отрицает здесь слово not, и встаёт оно сразу после can: I can not swim.",
        ...
        },
        {
          ...
          kind: "explain",
          text: [
            "У полной записи есть особенность: can и not пишутся слитно, одним " +
              "словом — cannot.",
            "Так только здесь. У остальных слов полная запись из двух слов: is not, " +
              "do not.",
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Вопрос строится просто: can выходит вперёд. Can you swim?",
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Английский берёт для этого то же слово can: You can buy milk here.",
          ],
        },
        {
        ...
        },
        {
          ...
          tone: "info",
          text:
            "В таких предложениях you — не обязательно твой собеседник.\n\n" +
            "«You can buy milk here» значит «здесь можно купить молоко» — кому " +
            "угодно, не только тебе.",
        },
        {
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          kind: "explain",
          text: [
            "Разница между двумя вопросами — в том, кто делает дело.",
            "Can you help? — дело делает собеседник, это просьба.",
            "Can I help you? — дело делаешь ты, это предложение помощи.",
          ],
        },
        {
          id: "please-v-prosbe",
        ...
        // ---- задания ----
        {
          ...
          hint: "Дело должен сделать собеседник — значит он и стоит после can.",
          why:
        ...
        },
        {
          ...
          answer: "I",
          exact: true,
          hint: "Дело делаешь ты — значит после can стоишь ты.",
        ...
        },
        {
          ...
          hint: "Смотри, кто будет делать дело.",
          why:
            "Can I help you? Дело делает тот, кто спрашивает. Во втором вопросе " +
  ...
  quiz: {
    ...
    questions: [
      ...
      },
      {
        ...
        why: "Can you help, please? После can стоит тот, кто будет делать дело.",
      },
      {
        id: "q-prosba-napisat",
        kind: "short",
