      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Такое слово называется наречием: оно стоит при глаголе и говорит, как " +
              "именно идёт дело. Always — всегда, sometimes — иногда.",
          ],
        },
        {
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "С формой be порядок другой: наречие идёт после неё. I am always busy.",
          ],
        },
        {
          id: "tablica-s-be",
          ...
          head: ["Что дальше", "Порядок", "Пример"],
          rows: [
        ...
        },
        {
          ...
          kind: "explain",
          text: [
            "Разницу заметить нетрудно, если смотреть на слово сразу после того, о ком речь.",
        ...
        },
        {
          ...
          text:
            ...
            "пропускает наречие вперёд себя только в одном случае: когда его там нет вовсе.",
        },
        {
          id: "primer-s-be",
          kind: "example",
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          kind: "explain",
          text: [
            "Порядок держится того же правила, что и с формой be.",
            "Наречие идёт после служебного слова, а не перед ним: сначала don't, потом " +
              "usually, потом глагол.",
            "«I usually don't work» тоже встречается, но начинающему проще держаться " +
              "одного места, и это место — после don't.",
          ],
        },
        {
          id: "chasto-i-redko",
          ...
          tone: "info",
          text:
            "I don't often work — «я редко работаю».\n\nОтдельного слова «редко» в этом " +
            "модуле нет: его заменяет отрицание при often.",
        },
        {
        ...
        },
        {
          ...
          hint: "В этом модуле наречие идёт после don't.",
          why:
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          explain:
            "В обоих вопросах наречие стоит перед глаголом. Ответы короткие и наречия в " +
            "себе не повторяют.",
        },
        {
          id: "zapis-v-voprose",
