    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        // ---- задания ----
        {
          ...
          hint: "Форма be, за ней not; слово a перед словом city остаётся.",
          why:
      ...
      blocks: [
        ...
        },
        {
          ...
          text:
            ...
            "Здесь оно то же самое, только стоит после формы be: You are right — «ты " +
            "прав», то есть «ты правильный в том, что сказал».",
        },
        {
          id: "zapis-prav",
          kind: "audio",
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          why:
            "Sorry, I'm not a driver. I'm a teacher. В первом варианте потеряно слово a, в " +
