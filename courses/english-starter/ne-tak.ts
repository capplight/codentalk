...
const module: Module = {
  ...
  sources: [
    ...
    },
    {
      ...
      section:
        "раздел 4а: «Sorry перед поправкой смягчает возражение» — РЕШЕНИЕ ВЛАДЕЛЬЦА " +
        "как преподавателя, 15 августа 2026. Учебного источника у утверждения нет ни " +
        "одного: искали методист и я, в словниках стоит только само слово. Это " +
        "опора врезки урока 4",
      license: "решение владельца, записано в файле",
    },
  ],
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          kind: "note",
          tone: "info",
          // Утверждение снималось на день: источника у него нет ни одного, искали
          // методист и я. 15 августа владелец подтвердил его как преподаватель, и
          // оно вернулось. Основание — его слово, записано в
          // docs/istochniki-vezhlivost.md, раздел 4а.
          text:
            "Перед поправкой можно поставить sorry — слово из модуля про приветствие. " +
            "Sorry, I'm not a doctor. I'm a nurse. Здесь оно не извинение за проступок, " +
            "а смягчение возражения.",
        },
        {
