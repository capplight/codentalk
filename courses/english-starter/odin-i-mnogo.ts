  ...
  quiz: {
    ...
    questions: [
      ...
      },
      {
        ...
        kind: "choice",
        outcome: "прибавлять es там, где одной буквы s мало: boxes, buses",
        prompt: "Про несколько коробок говорят boxes: на конце es, а не одна s. Почему одной s мало?",
        options: [
          { text: "На конце box уже слышится «с», и вторая такая рядом не прозвучит.", correct: true },
          { text: "Перед буквой s всегда ставят e." },
          { text: "У box особая форма, как у man и child." },
        ],
        hint: "Скажи «бокс» и попробуй добавить к нему «с».",
        why:
          "На конце box слышится «с». Ещё один такой звук рядом не прозвучит, " +
          "поэтому перед s вставляют e: boxes. У man и child форма особая, а буква " +
          "e перед s нужна не всегда: book — books.",
      },
      {
        id: "q-a-lishnee",
        kind: "choice",
