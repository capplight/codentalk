...
const module: Module = {
  ...
  sources: [
    {
      ...
      section:
        "УРОК ЧТЕНИЯ «Читаем опись комнаты». с. 56, шкала Reading for orientation, графа A1, дословно: «Can recognise familiar names, words/signs and very basic phrases on simple notices in the most common everyday situations». Опись комнаты — простое объявление обыденного случая, а названия вещей разобраны в уроках модуля. Объявления бюро находок здесь нет нарочно: такой урок уже стоит в модуле 8, и повторять его вторым не стоит. " +
        "Там же, с. 56, графа Pre-A1: «Can find information about places, times and prices on posters, flyers and notices» — ступень НИЖЕ нашей, значит поиск сведений по объявлению посилен наверняка. Здесь ищут место: в комнате или в сумке. " +
        "ЧТО СДЕРЖИВАЛО СОСТАВ ТЕКСТА, и это важнее самой опоры. Множественного числа курс здесь ещё не давал (модуль 8), поэтому вещи названы по одной. Определённого артикля the нет вовсе (модуль 10): на счёте «до модуля 10 не встречается ни разу» держится обоснование того урока. Перечисления через запятую с and нет (модуль 24). Предлога on нет (модуль 12), поэтому место названо заголовком, а не строкой. Первая редакция урока нарушала три из четырёх — нашёл методист. " +
  ...
  outcomes: [
    ...
    "проверять по описи, есть ли нужная вещь",
  ],
  ...
  lessons: [
      ...
      blocks: [
        {
          ...
          text: [
            "Названий предметов набралось много, и часть из них похожа на слух. Особенно " +
              "короткие: book и box начинаются одинаково.",
        ...
        },
        {
          ...
          rows: [
            ...
            ["car", "key", "гласный в середине: /ɑː/ и /iː/"],
            ["pen", "phone", "гласный: /e/ и /əʊ/"],
          ],
        },
        {
          ...
          text:
            "Слова this и that тоже похожи, а говорят они о разном: this о том, что " +
              "рядом, that о том, что подальше. Различает их конец слова: this кончается " +
              "на /s/, that — на /t/.",
        },
        {
          ...
          transcript:
            "What is this? — It is a book. — And what is that? — That is a box.",
        },
        {
          ...
          transcript: "Is this a car? — No, it isn't. It is a key!",
        },
        ...
        // ---- задания ----
        {
          ...
          answer: "book",
          accept: ["a book", "it is a book"],
          hint: "Про то, что рядом, спрашивают словом this.",
          why:
            "What is this? — It is a book. Слово this говорит о том, что рядом. " +
            "Не box: у book конец короче, один звук вместо двух.",
        },
        {
          id: "z2-chto-podalshe",
          kind: "choice",
        ...
        },
        {
          ...
          hint: "Слушай гласный в середине слова.",
          why: "Is this a car? В car гласный /ɑː/, в key — /iː/.",
        },
        {
          id: "z4-chto-okazalos",
          kind: "short",
          ...
          prompt:
            ...
            "словом.",
          answer: "key",
          accept: ["a key", "it is a key"],
          hint: "Верное название стоит в самом конце записи.",
          why: "No, it isn't. It is a key! Ключ.",
        },
        {
    ...
    // =====================================================================
    // Урок чтения. Опись комнаты: короткие строки, в каждой одна вещь.
    // Читается не подряд, а поиском — есть в описи нужное или нет.
    //
    // ЧЕГО ЗДЕСЬ НЕТ И ПОЧЕМУ. Артикля `the`: он разбирается в модуле 10, и
    // до него в курсе не встречается ни разу — на этом счёте держится
    // обоснование того урока. Перечисления через запятую с `and`: оно
    // разбирается в модуле 24. Множественного числа: модуль 8. Всё три
    // поймал методист в первой редакции этого урока.
    //
    // Объявления бюро находок здесь тоже нет нарочно: такой урок уже стоит в
    // модуле 8, и два урока об одном и том же тексте — это не два урока.
    //
    // Опора — в `sources`.
    // =====================================================================
    {
      slug: "chitaem-opis-komnaty",
      title: "Читаем опись комнаты",
      estimatedMinutes: 12,
      outcome: "проверять по описи, есть ли нужная вещь",

      blocks: [
        {
          id: "zachem-chitat-opis",
          kind: "explain",
          text: [
            "Опись читают не подряд. В неё смотрят с одним вопросом: есть тут нужная " +
              "вещь или нет.",
            "Поэтому строки в описи короткие и стоят по одной. Так глаз находит слово " +
              "быстрее, чем в сплошной строке.",
          ],
        },
        {
          id: "opis-komnaty",
          ...
          genre: "notice",
          title: "ROOM",
          body: ["A table. A chair. A picture. A window."],
        },
        {
          id: "opis-sumki",
          kind: "text",
          genre: "notice",
          title: "BAG",
          body: ["A pen. A book. A key. A phone."],
        },
        {
          id: "artikl-v-opisi",
          kind: "note",
          tone: "info",
          text:
            "Перед каждой вещью стоит a: a table, a pen. В описи артикль не пропадает — " +
            "вещь называют так же, как в предложении.",
        },
        {
          id: "zagolovok-opisi",
          kind: "note",
          tone: "info",
          text:
            "Заголовок описи говорит, где лежит всё перечисленное под ним. Читать его " +
            "надо первым: без него строки называют вещи, но не место.",
        },
        ...
        // ---- задания ----
        {
          ...
          kind: "choice",
          about: "opis-sumki",
          prompt: "Где лежит книга?",
          options: [
            { text: "В комнате" },
            { text: "В сумке", correct: true },
            { text: "В описях книга не названа" },
          ],
          hint: "Найди слово book и посмотри, под каким оно заголовком.",
          why: "A book стоит в описи под заголовком BAG.",
        },
        {
          id: "z2-pervaya-veshch",
          kind: "short",
          about: "opis-komnaty",
          prompt: "Какая вещь названа в описи комнаты первой? Напиши по-английски.",
          answer: "a table",
          accept: ["table", "A table", "a table."],
          hint: "Первое слово после заголовка ROOM.",
          why: "A table. Дальше идут a chair, a picture и a window.",
        },
        {
          id: "z3-otmetit-chego-net",
          kind: "hottext",
          prompt: "Отметь вещи, которых нет ни в одной описи.",
          parts: [
            { text: "a bus", selectable: true, correct: true },
            { text: " · " },
            { text: "a key", selectable: true },
            { text: " · " },
            { text: "a chair", selectable: true },
            { text: " · " },
            { text: "a box", selectable: true, correct: true },
          ],
          hint: "Пройди по обеим описям и вычёркивай найденное.",
          why:
            "A bus и a box не названы нигде. Ключ стоит в описи сумки, стул — в описи " +
            "комнаты.",
        },
        {
          id: "z4-zachem-zagolovok",
          kind: "choice",
          prompt: "Что изменится, если убрать из описей заголовки ROOM и BAG?",
          options: [
            { text: "Ничего: вещи останутся названы" },
            { text: "Станет непонятно, где какая вещь", correct: true },
            { text: "Вещи придётся называть без артикля" },
          ],
          hint: "Прочитай строки без заголовков: на какой вопрос они больше не отвечают?",
          why:
            "Без заголовка опись говорит только, какие вещи есть. Где они — сказано " +
            "заголовком, и другого места для этого в описи нет.",
        },
      ],
    },
  ],
  ...
  quiz: {
    ...
    questions: [
      ...
      {
        id: "q-na-sluh-sobrat-otvet",
        kind: "order",
        outcome: "узнавать на слух названный предмет и понимать, где он",
        zvuk: "What is that? — That is my phone.",
        prompt: "Послушай запись и собери ответ собеседника из трёх частей.",
        items: ["my phone", "That", "is"],
        answer: [1, 2, 0],
        why:
          "That is my phone. Ответ повторяет то же слово that, что было в вопросе: " +
          "речь о предмете подальше.",
      },
      {
        id: "q-na-sluh-ispravit-predmet",
        kind: "short",
        outcome: "узнавать на слух названный предмет и понимать, где он",
        zvuk: "It isn't a box. It is a book.",
        prompt:
          "Послушай запись. Человек записал «It is a box», но ошибся. Напиши верное " +
          "английское слово.",
        answer: "book",
        accept: ["a book"],
        why:
          "It isn't a box. It is a book. Слова похожи началом, а различает их конец: " +
          "у box он длиннее на один звук.",
      },
      {
      ...
      // ---- чтение -----------------------------------------------------
      // Угол другой, чем в уроке. Там ищут вещь в одной из двух строк; здесь
      // вещь названа ДВАЖДЫ, в разных местах, и надо заметить оба.
      {
        id: "q-veshch-v-dvuh-mestah",
        kind: "choice",
        outcome: "проверять по описи, есть ли нужная вещь",
        prompt:
          "Две описи. «ROOM: a table. A pen.» и «BAG: a pen. A key.» Где лежит ручка?",
        options: [
          { text: "Только в сумке" },
          { text: "И в комнате, и в сумке", correct: true },
          { text: "Только в комнате" },
        ],
        hint: "Дочитай обе описи, а не останавливайся на первой находке.",
        why:
          "A pen названа в обеих описях. Найдя вещь в первой, опись закрывают рано — а " +
          "она бывает и во второй.",
      },
    ],
  },
};
