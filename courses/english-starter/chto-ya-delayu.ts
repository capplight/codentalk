      ...
      blocks: [
        {
          ...
          text: [
            ...
            // Слово «время» здесь впервые в курсе означает не часы, а форму
            // глагола. Поэтому оно вводится через русскую тройку времён,
            // знакомую взрослому со школы, а не объявляется готовым термином:
            // четырьмя уроками позже в этом же модуле «время» снова означает
            // часы, и без опоры ученик спотыкается. Нашёл редактор.
            "В русском у глагола есть время: прошедшее, настоящее, будущее. " +
              "У work, live, study тоже есть время, и оно называется Present Simple.",
          ],
        },
        {
          id: "tablica-glagolov",
        ...
        },
        {
          ...
          text:
            ...
            "doctor.\n\nЛибо действие — I work. Вместе am и work не ставят: глагол здесь " +
            "стоит без окончания.\n\nЧто меняется, когда окончание появляется, разберём в " +
            "модуле «Прямо сейчас».",
        },
        {
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          explain:
            "Здесь четыре предложения об одном человеке. В первом стоит форма be — им " +
            "называют, кто это. В остальных трёх у глагола окончание -s.",
        },
        ...
        },
        {
          ...
          hint: "Это одно из трёх слов, после которых глагол меняется.",
      ...
      blocks: [
        ...
        },
        {
          ...
          perevod: {
            ...
            "He finishes at five.": "Он заканчивает в пять.",
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          explain:
            "Четыре предложения по порядку часов.\n\n" +
            "По-русски время можно поставить и в начало — «в восемь я ухожу на работу», " +
            "— и в конец. Посмотри на переводы: там оно гуляет.\n\n" +
            "По-английски место у него одно: конец предложения.",
        },
      ...
      blocks: [
        ...
        },
        {
          ...
          perevod: {
            ...
            "I finish at three.": "Я заканчиваю в три.",
        ...
        },
        {
          ...
          perevod: {
            ...
            "He finishes at three.": "Он заканчивает в три.",
  ...
  quiz: {
    ...
    questions: [
      ...
      },
      {
        ...
        // Прежний разбор говорил «окончание достаётся тому, кто один» — а you
        // тоже бывает об одном человеке, и ученик, выбравший его, читал
        // подтверждение своей ошибки. Врезка `tolko-tretye-lico` урока 2 всё
        // это время говорила верно; расхождение было внутри курса.
        why:
          "После he. Окончание -s берут только he, she и it. После I, you, we и they " +
          "глагол стоит как в словаре — даже если человек один.",
      },
      {
      ...
      },
      {
        ...
        kind: "short",
        outcome: "рассказывать о своём дне четырьмя предложениями",
        // «Третий шаг» проверял память о нашей схеме рассказа, а сама строка
        // стояла в z1-sobrat-den того же модуля.
        prompt: "Ты заканчиваешь в пять. Скажи об этом целиком, начни с I.",
        answer: "I finish at five.",
        exact: true,
        accept: ["I finish at five"],
        why: "I finish at five. После глагола идёт время, а перед часом — предлог at.",
      },
      {
