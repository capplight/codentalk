    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          kind: "choice",
          prompt: "Тебе нравится водить машину. В каком предложении нет ошибки?",
          options: [
            { text: "I like drive." },
            { text: "I like to drive.", correct: true },
            { text: "I like to drives." },
          ],
          hint: "Нужно to, а глагол после него — без окончания.",
          why:
            "I like to drive. Без to получается два глагола подряд, а окончание -s " +
      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "«А тебе нравится кофе?» — о вкусах не только рассказывают, о них и спрашивают.",
  ...
  quiz: {
    ...
    questions: [
      ...
      },
      {
        ...
        // одиннадцать раз, а «I like to cook» собирает задание урока 1. Взят
        // глагол, который в модуле ответом нигде не стоит.
        prompt: "Собери предложение: «Мне нравится водить машину.»",
        items: ["drive", "to", "I", "like"],
        answer: [2, 3, 1, 0],
        hint: "Между like и глаголом встаёт ещё одно слово.",
        why: "I like to drive. Порядок: I, like, to, drive.",
      },
      ...
      },
      {
        ...
        kind: "choice",
        outcome: "говорить о своём желании: I'd like to go home",
        // Было сопоставление, повторявшее задание урока 7 вместе с разбором.
        prompt: "«I'd like to go home.» Что это значит?",
        options: [
          { text: "Я хочу пойти домой.", correct: true },
          { text: "Мне нравится ходить домой." },
          { text: "Я иду домой сейчас." },
        ],
        hint: "Оборот I'd like говорит о желании прямо сейчас.",
        why:
          "Я хочу пойти домой. I like было бы о вкусе вообще, а I am going — о том, " +
          "что идёт в эту минуту.",
      },
