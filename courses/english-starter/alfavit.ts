 ...
 *
 *    ЧЕГО НЕ ПОДТВЕРЖДАЕТ НИ ОДИН ИСТОЧНИК:
 ...
 *    — семь названий (F, L, M, N, S, X, Z) записаны через `e`, тогда как в
 *      источниках стоит `ɛ`. Это обычная словарная британская условность, но
 *      подтверждения ей в materials/ нет. Держим её по всему курсу.
 */
const module: Module = {
  slug: "alfavit",
