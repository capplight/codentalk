...
const module: Module = {
  ...
  outcomes: [
    ...
    "расставляет слова по алфавиту и находит нужное место в списке",
  ],
  ...
  lessons: [
    ...
    // =====================================================================
    {
      ...
      title: "Порядок букв",
      estimatedMinutes: 11,
      outcome: "расставляет слова по алфавиту и находит нужное место в списке",
      ...
      blocks: [
        {
          ...
          text: [
            "Двадцать шесть букв идут в строго определённом порядке, и его придётся помнить " +
              "наизусть. Это не прихоть: по алфавиту устроены словари, списки пассажиров, " +
              "оглавления, указатели в аэропорту и поля в бланках.",
            "Порядок нужен не для того, чтобы рассказать алфавит от начала до конца. Он нужен, " +
              ...
              "а фамилия на W — в самом конце списка.",
          ],
        },
        {
          id: "primer-spiska",
          kind: "example",
          caption: "Список имён по алфавиту",
          text: "Alim\nDana\nKarim\nNurlan\nZarina",
          explain:
            "Сравнивают по первой букве: A идёт раньше D, D раньше K и так далее. Если первые " +
            "буквы совпадают, смотрят на вторую, потом на третью — так же, как в русском.",
        },
        {
          id: "opasnye-mesta",
          kind: "note",
          tone: "mistake",
          text:
            "Чаще всего сбиваются в середине и ближе к концу: после I идёт J, а не K; " +
            "между U и X стоят сразу две буквы — V и W. Проверить себя просто: если в " +
            "сомнении, проговори кусок с начала ближайшей знакомой буквы.",
        },
        {
          id: "zapis-poryadka",
          kind: "audio",
        ...
        },
        {
          ...
          answer: "J",
          accept: ["j"],
          hint: "Не K — между ними есть ещё одна.",
  ...
  quiz: {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: "W",
        accept: ["w"],
        why: "После V идёт W, и только потом X. Здесь сбиваются чаще всего.",
      },
      {
        id: "q-najti-oshibku",
        kind: "hottext",
