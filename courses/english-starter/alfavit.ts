 ...
 * с алфавита». Список ошибок, которых здесь стараюсь избежать, —
 * docs/format-uroka.md, «Чему научил первый модуль».
 *
 * ЧТО ЗДЕСЬ НЕ ТАК, И ЭТО ИЗВЕСТНО:
 *
 * 1. Написано два урока, программа отводит модулю восемь. Это первая часть.
 *
 ...
 *    подаётся написанием через дефис, а не голосом. Как появится звук, те же
...
const module: Module = {
  ...
  outcomes: [
    "записывает слово, продиктованное по буквам, и сам записывает слово по буквам",
  ...
  lessons: [
    // =====================================================================
    {
      ...
      estimatedMinutes: 13,
      outcome: "записывает слово, продиктованное по буквам, и сам записывает слово по буквам",
      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "Латинские буквы знакомы по вывескам, брендам и раскладке клавиатуры. Но узнавать " +
              "букву и знать её название — разные умения. Прочитать hotel сможет почти каждый; " +
              "сказать, из каких букв оно состоит, — уже нет.",
            "Названия нужны не для порядка. Имя, фамилию, адрес и номер брони в английском " +
              "постоянно уточняют по буквам: собеседник произносит их одно за другим, и надо " +
        ...
        },
        {
          ...
          tone: "mistake",
          text:
            "Труднее всего даются гласные и две согласные — G и J. Их путают чаще прочего: " +
            "G называется /dʒiː/, а J — /dʒeɪ/, начало у них одинаковое. Различает их только " +
            "гласный: у G он тот же, что в B и C, у J — тот же, что в A и K.",
        },
        {
          id: "zed-ili-zee",
          kind: "note",
        ...
        },
        {
          ...
          explain:
            ...
            "письме их принято разделять дефисом.",
        },
        {
          id: "slovar-bukvy",
          kind: "vocab",
        ...
        },
        {
          ...
          phrase: "A-L-I-M",
          translation: "Так называют буквы имени одну за другой.",
          hint: "Не торопись: между буквами делают маленькую паузу.",
          why:
            "Своё имя по буквам приходится называть чаще всего остального, поэтому его стоит " +
            "довести до беглости. Машина это упражнение не оценивает — оно для тебя.",
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Русский пишет «казахский язык», «русский», «англичанин» со строчной. Английский — " +
              "Kazakh, Russian, English. Это одна из самых частых ошибок русскоязычного " +
              "ученика, и она заметна сразу.",
          ],
        },
        {
          id: "primer-zaglavnyh",
          ...
          explain:
            ...
            "заглавной. По-русски из этого списка с заглавной было бы только имя и страна.",
        },
        {
          id: "i-vsegda",
          kind: "note",
        ...
        },
        {
          ...
          exact: true,
          hint: "Ошибок две: местоимение и название страны.",
          why:
        ...
        },
        {
          ...
          hint: "Два слова из трёх называют что-то определённое: день недели и язык.",
          why:
            "Country — обычное существительное, оно пишется со строчной. Monday и English " +
            "называют определённый день и определённый язык, поэтому с заглавной.",
        },
        {
  ...
  // Требуют написать ответ самому: 5 из 8. Оба итога проверяются по существу.
  // =======================================================================
  quiz: {
    ask: 6,
    passRatio: 0.7,
    questions: [
      ...
      },
      {
        ...
        why: "Страна и язык пишутся с заглавной: Kazakhstan, Russian. Dana и English верны.",
      },
      {
        ...
        exact: true,
        why:
          "Kazakhstan — страна, поэтому с заглавной. Написание со строчной здесь ошибка, " +
          "какой бы страна ни была.",
      },
    ],
  },
};
