    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          tone: "info",
          text:
            "В последней строке стоит слово and — это «и». Оно соединяет то, что " +
            "перечисляют: Kazakh, Russian and English. Перед ним в перечислении ставят " +
            "запятые, а само оно идёт только перед последним словом.",
        },
        {
