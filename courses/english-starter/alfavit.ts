 ...
 *
 * 2. Десять заданий модуля дают буквы ТЕКСТОМ, через дефис, а не голосом, —
 *    и проверяют тем самым набор, а не слух. Писалось это тогда, когда звука у
 *    курса не было вовсе; теперь он есть (решение владельца 16 августа), и урок
 *    слушания этого же модуля стоит на трёх настоящих записях.
 *
 *    ЗНАЧИТ ЭТО ВОПРОС ВЛАДЕЛЬЦУ, А НЕ ОПИСКА: перевести ли часть диктовок на
 *    голос. Нашёл методист 31 августа 2026, прежняя запись здесь утверждала,
 *    будто записей нет вовсе, и отправляла следующего проверяющего к давно
 *    закрытому вопросу.
 *
...
const module: Module = {
  ...
  lessons: [
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          id: "tablica-alfavita",
          kind: "table",
          caption: "Двадцать шесть букв и их названия — нажми на букву, чтобы услышать",
          // Каждая буква звучит отдельно. Записи алфавита целиком мало: она
          // показывает порядок, а разобрать трудную букву по ней нельзя —
          // приходится переслушивать всё. Нашёл владелец, пройдя урок.
          zvuk: {
        ...
        },
        {
          ...
          tone: "info",
          text:
            "Буква — то, что написано, а звук — то, что слышно. Это не одно и то же: " +
            "буква X одна, а звука в ней два — /ks/.\n\n" +
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        {
          // Слово `and` работает в курсе с этого места и до конца — 437 раз, —
          // а разбирается только в модулях 11 и 24. Ровно та же дыра, что была
          // у `the`. Строку поставили здесь, где слово впервые попадается
          // ученику; правило соединения предложений осталось модулю 24.
          // Нашёл методист.
          id: "slovo-and",
          kind: "note",
          tone: "info",
          text:
            "В последней строке стоит слово and — это «и». Здесь оно соединяет то, " +
            "что перечисляют: Kazakh, Russian and English. В перечислении запятые " +
            "ставят между словами, а and — перед последним.\n\n" +
            "Соединять им можно и целые предложения, и это видно во врезке ниже.",
        },
        {
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        {
          // Перевода этот пример НЕ получает, и это решение, а не пропуск: слова
          // стоят здесь предметом сортировки, а не смысла — важно, какая буква
          // вторая, а не что слово значит. Карточки `school` и `some` курс даёт
          // позже, в модулях 11 и 9. Найдено методистом 31 августа 2026 как
          // возможный пропуск; пропуска нет.
          id: "primer-spiska",
          kind: "example",
        ...
        },
        {
          ...
          text:
            ...
            "Здесь и сбиваются. Сбиться — не беда, начинать алфавит сначала не надо. " +
            "Вернись к ближайшей букве, в которой уверен, и иди от неё: от K — K, L, M, N.",
        },
        {
          id: "zapis-poryadka",
          kind: "audio",
    ...
    // =====================================================================
    // Урок слушания. Первый в курсе, и единственный возможный в первом
    // модуле: связного текста здесь не построить — словарь двадцать одно
    // слово, — а буквы на слух разобрать уже можно.
    //
    // Опора — `sources`: руководство Cambridge для младших ступеней прямо
    // называет умение «understand letters of the English alphabet when heard»,
    // и оно стоит ступенью НИЖЕ нашей.
    //
    // Расшифровки записей спрятаны за кнопку: пока текст на виду, «послушай и
    // запиши» — это списывание. Кнопка открыта всегда.
    // =====================================================================
    {
      slug: "slushaem-po-bukvam",
      ...
      blocks: [
        {
          id: "zachem-slushat-bukvy",
          kind: "explain",
          text: [
            "Диктовать по буквам приходится всюду, где имя записывают на слух: у стойки " +
              "гостиницы, по телефону, в бланке.",
            "Слушать это труднее, чем говорить самому: буквы идут одна за другой и не " +
              "складываются в знакомое слово, пока не кончатся.",
          ],
        },
        {
          id: "kak-lovit-bukvy",
          ...
          tone: "info",
          text:
            "Записывай буквы сразу, по одной, не пытаясь угадать слово целиком. " +
              "Угадать не выйдет: слово становится понятно только на последней букве.",
        },
        {
          id: "trudnye-na-sluh",
          kind: "table",
          ...
          head: ["Одна", "Другая", "Чем различаются"],
          rows: [
            ["G", "J", "начало одинаковое, конец разный: /dʒiː/ и /dʒeɪ/"],
            ["B", "V", "начало: /biː/ и /viː/"],
            ["M", "N", "конец: /em/ и /en/"],
            ["S", "F", "конец: /es/ и /ef/"],
          ],
        },
        {
          id: "zapis-diktuyut-slovo",
          kind: "audio",
          skryt: true,
          pace: "slow",
          caption: "Послушай, как диктуют слово",
          transcript: "T-E-A. Tea.",
        },
        {
          id: "zapis-diktuyut-imya",
          kind: "audio",
          skryt: true,
          pace: "slow",
          voice: "два голоса",
          caption: "Послушай, как записывают имя",
          transcript: "How do you spell your name? — D-A-N-A. Dana.",
        },
        {
          id: "zapis-tri-bukvy",
          kind: "audio",
          skryt: true,
          pace: "slow",
          caption: "Послушай три названия букв подряд",
          transcript: "J. V. N.",
        },

        // ---- задания ----
        {
          id: "z1-zapisat-slovo-so-sluha",
          kind: "short",
          about: "zapis-diktuyut-slovo",
          prompt:
            "Послушай первую запись и напиши слово, которое продиктовали. " +
            "Три буквы.",
          answer: "tea",
          accept: ["Tea", "TEA"],
          hint: "Последним звучит само слово целиком — по нему себя и проверь.",
          why:
            "T-E-A. Tea. Диктующий назвал три буквы, а потом произнёс слово целиком: " +
            "так делают всегда, чтобы записавший себя проверил.",
        },
        {
          id: "z2-imya-so-sluha",
          kind: "short",
          about: "zapis-diktuyut-imya",
          prompt: "Послушай вторую запись и напиши имя, которое продиктовали.",
          answer: "Dana",
          accept: ["dana", "DANA"],
          hint: "Имя начинается с буквы /diː/.",
          why: "D-A-N-A. Dana. Имя пишется с заглавной буквы.",
        },
        {
          id: "z3-o-chem-sprosili",
          kind: "choice",
          about: "zapis-diktuyut-imya",
          prompt: "Послушай вторую запись. О чём спросили первым делом?",
          options: [
            { text: "Как пишется имя", correct: true },
            { text: "Как зовут" },
            { text: "Откуда человек" },
          ],
          hint: "В вопросе есть слово spell.",
          why:
            "How do you spell your name? — «как пишется твоё имя». Спрашивают не имя, " +
            "а его написание: имя спрашивающий уже слышал.",
        },
        {
          id: "z4-tri-bukvy",
          kind: "choice",
          about: "zapis-tri-bukvy",
          prompt: "Послушай третью запись. Какие три буквы прозвучали?",
          options: [
            { text: "G, B, M" },
            { text: "J, V, N", correct: true },
            { text: "J, B, M" },
          ],
          hint: "Все три — из тех пар, что стоят в таблице выше.",
          why:
            "J. V. N. Каждая — вторая в своей паре: не G, а J; не B, а V; не M, а N.",
        },
        {
          id: "z5-prodiktovat-vsluh",
          kind: "speak",
          prompt: "Продиктуй вслух по буквам слово water, а потом произнеси его целиком.",
          phrase: "W-A-T-E-R. Water.",
          translation: "W-A-T-E-R. Вода.",
          hint: "После каждой буквы делай короткую остановку, иначе записать не успеют.",
          why:
            "Сначала буквы по одной, потом слово целиком — так диктующего понимают с " +
            "первого раза.",
        },
      ],
    },
  ...
  quiz: {
    ...
    questions: [
      // ---- слушание ---------------------------------------------------
      // Другой случай и другой вид задания, чем в уроке: там диктовали tea и
      // Dana, здесь — фамилия и выбор пары на слух.
      {
        id: "q-na-sluh-familiya",
        kind: "short",
        outcome: "записывать со слуха слово, продиктованное по буквам",
        zvuk: "My surname is Petrov. P-E-T-R-O-V.",
        prompt: "Послушай запись и напиши фамилию, которую продиктовали.",
        answer: "Petrov",
        accept: ["petrov", "PETROV"],
        why: "P-E-T-R-O-V. Petrov. Фамилия пишется с заглавной буквы.",
      },
      {
        id: "q-na-sluh-zapisat-imya",
        kind: "short",
        outcome: "записывать со слуха слово, продиктованное по буквам",
        zvuk: "My name is Aigul. A-I-G-U-L.",
        prompt: "Послушай запись и напиши имя, которое продиктовали.",
        answer: "Aigul",
        accept: ["aigul", "AIGUL"],
        why:
          "A-I-G-U-L. Aigul. Сначала имя произнесли целиком, потом продиктовали по " +
          "буквам — записывать надо по второй части.",
      },
      {
        id: "q-zapisat-slovo",
        kind: "short",
        outcome: "узнавать букву по названию и записывать слово, продиктованное по буквам",
        prompt:
          "Собеседник диктует по телефону и называет буквы: /keɪ/, /iː/, /waɪ/. " +
          "Запиши слово, которое вышло.",
        answer: "key",
        accept: ["Key"],
        why:
          "Key. /keɪ/ — это K, /iː/ — E, /waɪ/ — Y. Последняя выглядит как русская У, " +
          "а называется иначе.",
      },
      {
        id: "q-po-bukvam",
        ...
        outcome: "узнавать букву по названию и записывать слово, продиктованное по буквам",
        prompt:
          "Ты заполняешь бланк, а собеседник записывает за тобой и не расслышал. " +
          "Продиктуй ему слово word.",
        answer: "W-O-R-D",
      ...
      },
      {
        ...
        kind: "choice",
        outcome: "узнавать частые буквосочетания и не читать их по названиям букв",
        // Прежний вопрос спрашивал, сколько звуков даёт ea в слове tea. В таблице
        // урока у всех пяти сочетаний в графе «Звучит как» стоит одна запись, так
        // что «Один» верно для любой строки: вопрос проходился, не читая
        // английского. И рамка была урочной — задание 1 спрашивает то же про ck в
        // black. Спрошено о пятой строке таблицы, которой работа не касалась.
        // Первая правка взяла верный вариант дословно из врезки урока, и два
        // отвлекающих читались как один и тот же: «эр» — это и есть русское
        // название буквы Р. Нашли оба проверяющих.
        prompt: "Слова teacher, sister и water кончаются на одни и те же две буквы. Что слышно на их конце?",
        options: [
          { text: "Раскатистое «р», как в слове «мастер»" },
          { text: "Короткий неясный гласный, а «р» не слышно вовсе", correct: true },
          { text: "Английское название буквы R — /ɑː/" },
        ],
        hint: "Загляни в запись слова: /ˈtiːtʃə/. Чего в ней нет?",
        why:
          "Teacher — /ˈtiːtʃə/. Звук r на конце слова в британской речи не " +
          "произносят, и остаётся короткий неясный гласный.",
      },
      {
        id: "q-imya-po-bukvam",
        kind: "short",
      ...
      {
        id: "q-nazvanie-pervoy-bukvy",
        kind: "choice",
        outcome: "узнавать букву по названию и записывать слово, продиктованное по буквам",
        prompt: "Ты диктуешь слово yes. Какое название назовёшь первым?",
        options: [{ text: "/juː/" }, { text: "/waɪ/", correct: true }, { text: "/jes/" }],
        why:
          "Y — /waɪ/. Название /juː/ у буквы U, а /jes/ — это само слово, а не буква: " +
          "диктуя, слово не повторяют.",
      },
      {
      ...
      {
        id: "q-britanskoe-nazvanie-z",
        kind: "choice",
        outcome: "узнавать букву по названию и записывать слово, продиктованное по буквам",
        prompt: "Последнюю букву алфавита в Британии и в Америке называют по-разному. Как её называют британцы?",
        options: [{ text: "/es/" }, { text: "/ziː/" }, { text: "/zed/", correct: true }],
        why:
          "Z — /zed/. Название /ziː/ говорят в Америке, а /es/ — это буква S. Курс " +
          "держит британскую норму, и в диктовке важно назвать букву так, как её ждут.",
      },
      {
        id: "q-vopros-spell",
        kind: "short",
      ...
      {
        id: "q-otvet-na-prosbu-spell",
        kind: "choice",
        outcome: "понимать просьбу продиктовать слово и отвечать на неё по буквам",
        prompt: "Тебя просят: «Can you spell that, please?» Что сделать в ответ?",
        options: [
          { text: "Повторить слово громче." },
          { text: "Назвать буквы одну за другой.", correct: true },
          { text: "Произнести слово по слогам." },
        ],
        why:
          "Просят именно буквы: spell — «произнести по буквам». Повтор громче и деление " +
          "на слоги собеседнику не помогут — записать слово он всё равно не сможет.",
      },
      {
        id: "q-chto-prosyat",
        kind: "choice",
