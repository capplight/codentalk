  ...
  quiz: {
    ...
    questions: [
      ...
      },
      {
        ...
        prompt: "Слово teacher кончается на er. Что слышно в конце?",
        options: [
          { text: "Короткое неясное «э»", correct: true },
          { text: "Твёрдое «эр», как в слове «мастер»" },
          { text: "Название буквы R" },
        ],
        hint: "То же слышно в конце слов sister и water.",
        why:
          "Teacher — /ˈtiːtʃə/. Звук r на конце слова в британской речи не " +
          "произносят, и остаётся короткое неясное «э».",
      },
      {
        id: "q-imya-po-bukvam",
        kind: "short",
