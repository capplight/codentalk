    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          kind: "explain",
          text: [
            "Слово did выходит вперёд и берёт на себя прошедшее, а сам глагол за ним стоит словарной формой: go, а не went.",
        ...
        },
        {
          ...
          answer: [3, 2, 1, 0],
          hint: "Первым стоит did, потом тот, о ком речь, потом само действие.",
      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "Тебя спросили: Did you go to the stadium? — «Ты ходил на стадион?»",
        ...
        },
        {
          ...
          kind: "explain",
          text: [
            "После короткого ответа можно добавить подробность.",
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          kind: "explain",
          text: [
            "О людях спрашивает who, и после него сразу идёт was: who — это и есть тот, о ком речь.",
      ...
      blocks: [
        ...
        },
        {
          ...
          text:
            ...
            "о неделе того, кому пишут.\n\nВопросы стоят в конце: в образце ниже их " +
            "два.",
        },
        {
          id: "slovar-pisma",
