    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          kind: "explain",
          text: [
            "Форм две, и выбирают их так же, как в модуле «Это было»: I was tired, I was working.",
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Поэтому рядом ставят время: I was working at seven.",
            "Или целый промежуток: I was working all evening.",
          ],
        },
        {
        ...
        },
        {
          ...
          text: [
            ...
            "Длительному действию годятся оба вида: и точка, и промежуток.",
          ],
        },
        {
          id: "gde-stoit-oborot",
