      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "Ученик повесил объявление: «I found a bag. Come and take it.» — «Я нашёл сумку. Приходите и заберите.»",
      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "За столом, на площадке и в парке нужны свои слова, и здесь они собраны.",
            "Что на столе, чем заняты, что живёт вокруг и о ком говорят люди.",
            "Многие названия составлены из двух слов: table tennis, main course, digital camera.",
            "Первое слово уточняет второе: camera — фотоаппарат, digital camera — цифровой фотоаппарат.",
          ],
        },
        {
          id: "chto-na-stole",
        ...
        },
        {
          ...
          explain:
            "Семь строк об одном обеде. В четырёх стоит сравнение — так о еде и " +
            "говорят: что вкуснее, что дешевле, что дольше. А в первой не сравнение, " +
            "а выделение: the best part.",
        },
        {
        ...
        },
        {
          ...
          explain:
            "Шесть строк: в четырёх сравнение, в двух выделение — the tallest, the " +
            "longest. Имя занятия часто выходит из имени игры: tennis — tennis " +
            "player, football — football player.",
        },
        {
          id: "zhivoe-vokrug",
          kind: "table",
