  ...
  sources: [
    ...
    },
    {
      ...
      section:
        ...
        "ИМЯ ВРЕМЕНИ. Та же строка — опора того, что урок 1 называет время ученику: " +
        "«Past simple: past events». Имя даётся один раз на ступень, при первой " +
        "встрече, и первая встреча здесь: до модуля 1 прошедшего в курсе нет. " +
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          kind: "explain",
          text: [
            "Семь слов слева — I, you, he, she, it, we, they — в грамматике зовут лицами; отсюда и подпись таблицы.",
        ...
        },
        {
          ...
          items: [
            ...
            { term: "the", translation: "тот самый, о котором речь", example: "We were at the station.", hint: "/ðə/, а в the apple — /ði/" },
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "По-английски слова переставляют: форма глагола выходит вперёд, а тот, о " +
