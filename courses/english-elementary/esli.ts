      ...
      blocks: [
        {
          ...
          text: [
            ...
            "И тут ловушка: по-русски будущее стоит в обеих половинах.",
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Главная половина бывает четырёх видов, а половина с условием не меняется.",
          ],
        },
        {
    ...
    questions: [
      ...
      // ---- итог 4 ----
      {
        ...
        why:
          ...
          "действиях, а условие названо половиной с if.",
      },
      {
