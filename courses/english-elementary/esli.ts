 ...
 *
 * ИМЯ ГЛАВНОЙ ВЕЩИ МОДУЛЯ — «УСЛОВИЕ». Часть строки со словом `if` зовётся
 * «частью с условием», вторая — «главной частью». Те же два имени
 ...
 * arrive» — таблица из двух частей, объяснение «в части со словом when
 ...
 * ok with you». Она же подпирает обратный порядок частей.
 *
  ...
  sources: [
    ...
    },
    {
      ...
      section:
        ...
        "`will` в главной части и настоящее время после `if`. Тот же " +
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Строка распадается на две части, и в каждой своё время.",
            "И тут ловушка: по-русски будущее стоит в обеих частях.",
            "«Если приедешь» — это уже будущее, а по-английски там настоящее: if you come.",
            "То же было в модуле «По расписанию» со строкой I'll call you when I arrive — «я позвоню, когда приеду».",
          ],
        },
        {
          ...
          head: ["Часть с условием", "Главная часть"],
          rows: [
        ...
        },
        {
          ...
          kind: "explain",
          text: [
            "В главной части стоит will — обещание о будущем.",
        ...
        },
        {
          ...
          text:
            ...
            "\n\nВ части с условием будущего не ставят: If you arrive early.",
        },
        {
          ...
          explain:
            "В обеих строках с will главная часть обещает, а часть с " +
        ...
        },
        {
          ...
          hint: "Проверь обе части: где стоит will и какое окончание у глагола.",
          why:
            "If the bus breaks down, we'll take the underground. В первой " +
            "записи will попало в часть с условием, а во второй у глагола " +
            "пропало окончание.",
        },
        {
          id: "z3-otmetit-glavnye-poloviny",
          kind: "hottext",
          prompt: "Отметь главные части — те, где дано обещание.",
          parts: [
        ...
        },
        {
          ...
          why:
            "If the alarm clock rings, I'll wake up. Запятая делит части, " +
        ...
        },
        {
          ...
          hint: "В части с условием стоит настоящее время, даже если речь о завтрашнем дне.",
          why:
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "В её строке не обещание, а просьба: If you find it, call me.",
            "Главная часть бывает четырёх видов, а часть с условием не меняется.",
          ],
        },
        {
          id: "chetyre-vida-glavnoy-poloviny",
          kind: "table",
          caption: "Четыре вида главной части",
          zvuchat: [
        ...
        },
        {
          ...
          text: [
            ...
            "Часть с условием во всех четырёх видах одна и та же.",
          ],
        },
        {
        ...
        },
        {
          ...
          explain:
            "Три строки, и часть с условием у всех одинаковая. Различаются " +
            "главные части: просьба, слово can и обещание с will.",
        },
        {
          id: "slovar-propazhi",
          kind: "vocab",
        ...
        // ---- задания ----
        {
          ...
          kind: "gap",
          prompt:
            "В главной части стоит просьба позвонить. Допиши глагол.",
        ...
        },
        {
          ...
          hint: "Смотри только на главные части: условие у них одинаковое.",
          why:
        ...
        },
        {
          ...
          kind: "hottext",
          prompt: "Отметь строки, где главная часть говорит «так можно».",
          parts: [
          ...
          hint: "Ищи слово can в главной части.",
          why:
        ...
        },
        {
          ...
          hint: "Слово can стоит в главной части, перед глаголом.",
          why:
            "If you look for it in the evening, you can turn on the light. " +
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Он говорит When it rains, она — If it rains.",
            "Слово меняется одно, а смысл — весь.",
          ],
        },
        {
          id: "if-protiv-when",
        ...
        },
        {
          ...
          text: [
            ...
            "Устроены обе строки одинаково: настоящее время после союза, will в главной части.",
        ...
        // ---- задания ----
        {
          ...
          why:
            ...
            "опоздание наверняка, а в третьей записи will попало в часть с " +
            "условием.",
        },
        {
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          tone: "info",
          text:
            "Каждая строка памятки состоит из части с условием и главной " +
            "части.\n\nГлавная часть бывает просьбой, обещанием, словом " +
        ...
        },
        {
          ...
          hint: "Главная часть четвёртой строки — просьба.",
        ...
        },
        {
          ...
          kind: "choice",
          prompt:
            "Строка: If you pay by credit card, you can take it today. Что стоит в главной части?",
          options: [
            { text: "Просьба." },
            { text: "Слово can: так можно.", correct: true },
            { text: "Обещание с will." },
          ],
          hint: "Смотри вторую часть строки, после запятой.",
          why:
      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "Ученик написал другу: «Maybe we'll meet tomorrow.» — «Может быть, завтра встретимся.»",
        ...
        },
        {
          ...
          text: [
            ...
            "Во второй и третьей строке часть с условием стоит впереди, и после неё запятая.",
        ...
        },
        {
          ...
          explain:
            ...
            "случай, третья — запасной ход. В главной части второй строки " +
        ...
        },
        {
          ...
          why:
            "If it rains, we'll go to the cafe. В третьей записи части " +
        ...
        },
        {
          ...
          checklist: [
            ...
            "после части с условием стоит запятая",
          ],
          hint:
  ...
  quiz: {
    ...
    questions: [
      ...
      // ---- итог 1 ----
      {
        ...
        hint: "Одно слово стоит не в своей части.",
        why:
      ...
      },
      {
        ...
        options: [
          ...
          { text: "У глагола в части с условием пропало окончание.", correct: true },
          { text: "После taxi нужна запятая." },
        ],
        hint: "Спроси, кто ломается: я, ты или автобус.",
        why:
          "Окончание пропало: the bus breaks down. В этой части глагол " +
      ...
      // ---- итог 4 ----
      {
        ...
        kind: "choice",
        outcome: "находить в письме, что случится при каком условии",
        // Строка была дословно из памятки для чтения того же модуля. Взята новая
        // строка того же жанра, слова — карточки этого же модуля.
        prompt:
          "В памятке строка: If the bike breaks down, you can leave it in the car park and take another one. Что она разрешает?",
        options: [
          { text: "Чинить велосипед самому." },
          { text: "Оставить сломанный велосипед на парковке и взять другой.", correct: true },
          { text: "Оставлять велосипед где угодно." },
        ],
        hint: "Смотри главную часть — ту, где стоит can.",
        why:
          "Оставить сломанный и взять другой. Слово can стоит именно при этих " +
          "действиях, а условие называет часть с if.",
      },
      {
        ...
        outcome: "находить в письме, что случится при каком условии",
        prompt:
          "Строку If you come in May, I'll show you the city перепиши так, чтобы главная часть стояла впереди.",
      ...
      },
      {
        ...
        why:
          "If the bus breaks down, I'll send a message. После части с " +
