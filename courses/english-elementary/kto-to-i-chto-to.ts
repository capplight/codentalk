      ...
      blocks: [
        ...
        },
        {
          ...
          text: [
            ...
            "Правило тут то же, что было со словами о людях и вещах.",
      ...
      blocks: [
        ...
        },
        {
          ...
          glossary: [
            ...
            // Форма found работает здесь впервые, а карточки find и found стоят в
            // модуле 21 — двумя уроками позже. Пара find — found в десяток
            // неправильных глаголов модуля 3 не попала, значит без этой записи
            // ученик читает форму глагола, которого не получал никак. Нашёл
            // методист.
            { term: "found", translation: "нашёл: прошедшее от find" },
          ],
        },
        {
      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "Нурлан написал другу о пропаже: «I lost my umbrella. It is bad.» — «Я потерял зонт. Плохо дело.»",
