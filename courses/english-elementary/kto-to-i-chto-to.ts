      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Он хочет сказать, что сумку взяли, но имени назвать не может.",
            "Он не видел, кто это был, и всё равно ему надо об этом сказать.",
            "Для такого случая в английском есть свои слова.",
          ],
        },
        {
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Официант отвечает, что не видел ни человека, ни вещи.",
            "По-русски он сказал бы «никого не видел» — с двумя отрицаниями сразу.",
            "По-английски отрицание в строке ставят одно, и слово при нём меняется.",
          ],
        },
        {
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Для короткого ответа в английском есть два слова.",
            "Они сами по себе отрицательные, и глагол при них остаётся обычным.",
          ],
        },
        {
          id: "korotkiy-otvet",
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Она хочет сказать, что пришли все и что всё готово.",
            "По-русски «все» — это много людей, и глагол при них во множественном числе.",
            "По-английски выходит наоборот, и на этом спотыкаются чаще всего.",
          ],
        },
        {
      ...
      blocks: [
        ...
        },
        {
          ...
          text: [
            ...
            "А everywhere в отрицании нам не нужно: «нигде» говорят через not … anywhere.",
          ],
        },
        {
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Им хочется чего-нибудь холодного и чего-нибудь поесть.",
            "Уточнение к таким местоимениям ставят особым образом.",
          ],
        },
        {
