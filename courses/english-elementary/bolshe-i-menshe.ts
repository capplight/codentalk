      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Данияр говорит I watched the match with my younger brother.",
      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "Дана написала Алиму записку о двух квартирах, и он не понял, какую она берёт.",
  ...
  quiz: {
    ...
    questions: [
      ...
      // ---- итог 2 ----
      {
        ...
        why:
          "Expensive. В нём три слога — ex-pen-sive, — и такие слова берут more; " +
