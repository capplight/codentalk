  ...
  quiz: {
    ...
    questions: [
      ...
      },
      {
        ...
        outcome: "находить в советах приезжему, что стоит делать, а что нет",
        prompt:
          "В письме строка: Why don't we go riding on Saturday? Что делает автор этой строкой? Ответь одним словом по-русски.",
        answer: "зовёт",
        accept: ["Зовёт", "зовет", "приглашает"],
        // Прежняя подсказка содержала ответ дословно: «автор зовёт поехать вместе».
        hint: "Обрати внимание на we: дело в строке общее, на двоих.",
        why:
