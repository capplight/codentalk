  ...
  quiz: {
    ...
    questions: [
      ...
      // ---- итог 4 ----
      {
        ...
        // строк, а не разбирал их. Взята другая вещь, и ответ надо написать.
        id: "q-ispravit-zapret-na-svobodu",
        kind: "short",
        outcome: "сказать, что делать не обязан: You don't have to bring a kit",
        prompt:
          "Ученик хотел сказать «кепку приносить не обязательно», а написал: You " +
          "mustn't bring a cap. Запиши строку без ошибки.",
        answer: "You don't have to bring a cap.",
        accept: ["You don't have to bring a cap"],
        hint: "Один оборот запрещает, другой снимает обязанность.",
        why:
          "You don't have to bring a cap. Оборот mustn't значит «нельзя», а «не " +
          "обязан» — это don't have to. По-русски обе строки часто переводят " +
          "одинаково, и это сбивает.",
      },
      {
      ...
      // ---- итог 5 ----
      {
        ...
        prompt:
          "В правилах строка: Every guest must show a ticket. Кто обязан это делать? Ответь одним словом по-английски.",
        answer: "guest",
      ...
      },
      {
        ...
        kind: "choice",
        outcome: "находить в правилах, что обязательно, а что нет",
        // Строка была дословно из текста для чтения того же модуля. Взята новая
        // строка того же жанра, и отвлекающий стоит настоящий: соседняя строка
        // тех же правил как раз запрещает бегать.
        prompt:
          "В правилах строка: You don't have to run: the pool is open all day. Что из этого следует?",
        options: [
          { text: "Бегать в бассейне запрещено." },
          { text: "Бассейн скоро закроется." },
          { text: "Спешить незачем: бассейн открыт весь день.", correct: true },
        ],
        hint: "Вторая половина строки объясняет первую.",
        why:
          "Спешить незачем. Оборот don't have to снимает обязанность, а запрещает " +
          "другой — mustn't.",
      },
