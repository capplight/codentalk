      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Обе кепки надо как-то назвать, и слово «кепка» тут не поможет.",
            "Нужны слова, которыми показывают: вот эта и вон та.",
          ],
        },
        {
          id: "ryadom-i-dalshe",
        ...
        },
        {
          ...
          explain:
            ...
            "Полностью разберём его в третьем уроке этого модуля.",
        },
        {
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Первый: вещей две, одну отложили, берут вторую.",
            "Второй: вещей много, и берут ещё одну сверх взятой.",
