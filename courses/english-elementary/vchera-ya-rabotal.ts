      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "Окончание одно, а пишется по-разному: work даёт worked, а study — studied.",
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Глухой звук произносят без голоса, звонкий — с голосом: приложи пальцы к " +
              "горлу и скажи «ссс», потом «ззз». На «ззз» горло дрожит.",
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Эти три слова так и зовут — слова порядка.",
          ],
        },
        {
          id: "slova-poryadka",
        ...
        },
        {
          ...
          kind: "explain",
          text: [
            "Слова порядка показывают, что было раньше, а что позже.",
      ...
      blocks: [
        ...
        },
        {
          ...
          text: [
            ...
            "Оборот времени не встаёт между тем, о ком речь, и делом: I worked " +
              "yesterday, а не I yesterday worked.",
          ],
        },
        {
