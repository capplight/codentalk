  ...
  quiz: {
    ...
    questions: [
      ...
      // ---- итог 6 ----
      {
        ...
        prompt:
          "В рассказе строка: I have never eaten such hot curry before. Что из этого следует?",
        options: [
          { text: "Автор не стал есть карри." },
          { text: "Такой острый карри автор пробует впервые.", correct: true },
          { text: "Карри оказался не острым." },
        ],
        hint: "Слово never говорит о том, чего не было раньше.",
        why:
          "Пробует впервые. В этот раз попробовал — потому он об этом и пишет.",
      },
      {
