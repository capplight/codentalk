      ...
      blocks: [
        ...
        },
        {
          ...
          text:
            ...
            "начала — по слову ago и глаголу в прошедшем.",
        },
        {
      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "Ученик написал: «I study English. It is good.»",
  ...
  quiz: {
    ...
    questions: [
      ...
      },
      {
        ...
        outcome: "находить в рассказе о курсе, кто чем занимается и сколько времени",
        prompt:
          "В письме строка: I was a beginner, and now I am in the advanced group. Что из этого следует?",
        options: [
          { text: "Человек продвинулся с начального уровня.", correct: true },
          { text: "Человек только начинает." },
          { text: "Человек занимается без группы." },
        ],
        hint: "Слово was говорит о прошлом, now — о сегодняшнем дне.",
        why:
          "Продвинулся с начального. Начинающим человек был раньше, а сейчас в " +
          "продвинутой группе.",
      },
