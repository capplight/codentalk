      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "Три глагола об одном и том же с разных сторон: что у тебя было, что тебе дали, что оказалось у тебя в руках.",
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          why:
            "Проверь по пяти пунктам: форма неправильного глагола у каждого дела, оборот времени один " +
            "раз в первой строке, was в строке о месте, обычный порядок слов, и все " +
            "четыре строки об одной поездке.",
        },
      ],
    },
  ],
