      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "Предмет здесь тот же, что в модуле «Вчера я работал»: как выглядит глагол, когда речь о прошлом.",
            ...
            "Такие глаголы называются неправильными. Слово «неправильный» тут не значит «с ошибкой»: оно значит, что общее правило на них не действует.",
      ...
      blocks: [
        ...
        },
        {
          ...
          text: [
            ...
            "В этом слове четыре буквы ough дают один звук /ɔː/, а t остаётся t.",
            "Правилом это не назовёшь: в других словах те же четыре буквы читаются иначе.",
          ],
        },
        {
          id: "ne-eated",
  ...
  quiz: {
    ...
    questions: [
      ...
      // ---- итог 6 ----
      {
        ...
        kind: "choice",
        outcome: "понимать короткое сообщение о поездке",
        // Строка была дословно из сообщения для чтения того же модуля — тринадцать
        // слов подряд. Нашёл методист, вторым проходом. Взята новая строка того же
        // жанра, слова — карточки этого же модуля. Разбор был в одну строку и
        // только повторял её.
        prompt:
          "В сообщении написано: «We met our guide on Sunday and took a ship along the " +
          "coast.» Что из этого верно?",
        options: [
          { text: "Вдоль берега они шли на корабле.", correct: true },
          { text: "Экскурсовода встретили в субботу." },
          { text: "Вдоль берега они шли пешком." },
        ],
        why:
          "Вдоль берега шли на корабле: took a ship. День назван воскресеньем, а не " +
          "субботой.",
      },
      // ---- итог 7 ----
      {
