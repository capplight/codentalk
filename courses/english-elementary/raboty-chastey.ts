...
export const rabotaProshloe: Quiz = {
  ...
  questions: [
    ...
    },
    {
      ...
      prompt: "Вечер вышел тихим. Допиши недостающее слово.",
      before: "The evening ",
      after: " quiet.",
      answer: "was",
      hint: "Вечер один.",
    ...
    // ---- Вчера я работал: окончание -ed ----
    {
      ...
      prompt: "Вчера ты занимался английским. Допиши глагол целиком.",
      before: "Yesterday I ",
      after: " English.",
      answer: "studied",
    ...
    },
    {
      ...
      prompt: "Дела шли по порядку. Допиши слово, с которого начинают рассказ.",
      before: "",
    ...
    },
    {
      ...
      prompt: "Ты взял с собой подарок. Допиши глагол.",
      before: "I ",
      after: " a gift.",
      answer: "took",
    ...
    },
    {
      ...
      why: "We bought a poster. Место покупки — гавань, а куплен постер.",
    },
    ...
    // ---- Я не делал ----
    {
      ...
      accept: ["I didn't go to the dentist", "I did not go to the dentist."],
    ...
    },
    {
      ...
      prompt: "Позвонить ты успел, а написать нет. Допиши союз.",
      before: "I called, ",
      after: " I didn't write.",
      answer: "but",
      hint: "Второе дело спорит с первым.",
      why: "I called, but I didn't write. Союз but ставят там, где вторая половина спорит с первой.",
    },
    {
    ...
    },
    {
      ...
      prompt:
        "В письме три строки: «I went to the coast. The train came late. What did you cook on Sunday?» Ответь на вопрос письма одной строкой: ты готовил рыбу.",
    ...
    },
    {
      ...
      why:
        "Мытьё посуды. Оно шло и не кончилось, а звонок случился разом — потому при " +
        "нём и стоит when.",
    },
  ],
};
...
export const rabotaPlany: Quiz = {
  ...
  questions: [
    ...
    },
    {
      ...
      prompt: "По приметам день выйдет ветреным. Допиши недостающее слово.",
    ...
    },
    {
      ...
      hint: "Просьба стоит в первой половине строки.",
    ...
    // ---- Я сделаю ----
    {
      ...
      why: "I will write to you in the evening. Годится и короткая запись I'll.",
    },
    {
      ...
      why: "I won't forget. Полная запись — I will not forget.",
    },
    {
    ...
    // ---- Уже договорились ----
    {
      ...
      prompt:
        "Вы условились с Алимом на четыре, и день назначен. Запиши строку целиком, начни с I'm.",
    ...
    },
    {
      ...
      prompt: "В четверг ты не работаешь, и это назначено. Допиши недостающее слово.",
      before: "I'm ",
    ...
    // ---- По расписанию ----
    {
      ...
      prompt: "Так стоит в расписании. Допиши глагол целиком.",
      before: "The museum ",
    ...
    },
    {
      ...
      answer: "five",
      accept: ["Five", "at five"],
      hint: "В строке названо два времени, и нужно второе.",
    ...
    },
    {
      ...
      why: "Let's walk to the park. Полная запись — Let us, но так почти не пишут.",
    },
    {
    ...
    // ---- Может быть ----
    {
      ...
      answer: "might",
      accept: ["may"],
      hint: "Слово стоит перед словарной формой глагола.",
      why: "It might snow tomorrow. Годится и may: оба слова говорят о возможном.",
    },
    {
      ...
      hint: "Спроси у каждой строки: человек знает или гадает?",
      why:
    ...
    // ---- Умения части ----
    {
      ...
      prompt: "Послушай. Что человек собирается делать? Ответь одним английским словом.",
      answer: "read",
      accept: ["Read"],
    ...
    },
    {
      ...
      prompt: "Послушай. В какой день назначено? Ответь одним английским словом.",
      answer: "Wednesday",
...
export const rabotaKakoyISkolko: Quiz = {
  ...
  questions: [
    ...
    },
    {
      ...
      why: "The second photo is better than the first one. Формы gooder не бывает: сравнение у good своё.",
    },
    {
      ...
      prompt:
        "В объявлении строка: «The leather bag is 9 000 tenge, and the wool one is 6 000.» Что дешевле? Ответь одним английским словом.",
      answer: "wool",
    ...
    // ---- Как это делается ----
    {
      ...
      after: ".",
      answer: "clearly",
      hint: "Словарная форма — clear.",
      why: "He speaks clearly. К прилагательному прибавляют -ly, и выходит слово о том, как идёт дело.",
    },
    {
      ...
      why: "She plays well. У good слово о действии своё — well.",
    },
    {
    ...
    // ---- Сколько чего ----
    {
      ...
      why: "There aren't many tickets left. Слово much идёт с тем, что не считают поштучно.",
    },
    {
      id: "ch3-hvatit-li",
      kind: "gap",
      ...
      answer: "enough",
      hint: "Слово стоит перед самой вещью.",
    ...
    },
    {
      ...
      answer: "oil",
      accept: ["Oil"],
      hint: "Вторая вещь названа в конце второй реплики.",
    ...
    // ---- Кто-то и что-то ----
    {
      ...
      why: "I didn't see anyone in the hall. Годится и anybody: слова эти равны.",
    },
    {
    ...
    },
    {
      ...
      answer: "45000",
      accept: ["45 000", "45000 tenge", "45 000 tenge"],
...
export const rabotaOpytIPravila: Quiz = {
  ...
  questions: [
    ...
    },
    {
      ...
      prompt:
        "В записке строка: «I have already paid for the room, but I haven't packed the bags yet.» Что осталось сделать? Ответь одним английским словом.",
      answer: "bags",
    ...
    // ---- Надо и не надо ----
    {
      ...
      prompt: "Обязанность лежит на одном другом человеке. Допиши недостающее слово.",
      before: "My colleague ",
      after: " to wear a uniform.",
      answer: "has",
      hint: "Человек один, и форма при нём своя.",
      why: "My colleague has to wear a uniform. При одном другом человеке стоит has, а не have.",
    },
    {
      ...
      prompt: "Послушай. Что делать необязательно? Ответь одним английским словом.",
      answer: "ticket",
    ...
    // ---- Стоит и не стоит ----
    {
      ...
      why: "You shouldn't walk in the dark. Полная запись — you should not.",
    },
    {
      ...
      hint: "Совет сделать стоит в первой половине строки.",
    ...
    // ---- Раньше мог ----
    {
      ...
      prompt: "В шесть лет плавать ты не умел. Допиши недостающее слово.",
      before: "At six I ",
      after: " swim.",
      answer: "couldn't",
      accept: ["could not"],
      hint: "Об умении в прошлом говорят одним словом, и здесь оно с отрицанием.",
      why: "At six I couldn't swim. Полная запись — I could not swim.",
    },
    {
      ...
      prompt: "Послушай. Что человек умел в семь лет? Ответь одним английским словом.",
      answer: "draw",
      accept: ["Draw", "drawing"],
    ...
    // ---- Вежливо ----
    {
      ...
      why: "Could you repeat that? Слово could звучит мягче, чем can, и потому идёт к незнакомому.",
    },
    {
      id: "ch4-chto-luchshe",
      kind: "gap",
    ...
    // ---- Если ----
    {
      ...
      prompt: "При дожде вы останетесь дома. Допиши глагол целиком.",
      before: "If it ",
    ...
    // ---- Который ----
    {
      ...
      why: "This is the album which I bought in Almaty. Годится и that: о вещи оба слова равны.",
    },
    {
      ...
      hint: "Вещь названа в самом конце второй реплики.",
    ...
    // ---- Он сказал, что ----
    {
      ...
      prompt: "Тебе назвали того, кому сказали. Допиши глагол.",
      before: "She ",
    ...
    },
    {
      ...
      prompt: "Ты ждёшь согласия собеседника. Допиши хвостик вопроса.",
      before: "The film was great, ",
      after: " it?",
      answer: "wasn't",
      hint: "Хвостик берёт ту же форму, что в первой половине, но с отрицанием.",
      why:
        "The film was great, wasn't it? В первой половине стоит was, значит и хвостик " +
        "строится от was.",
    },
  ],
};
