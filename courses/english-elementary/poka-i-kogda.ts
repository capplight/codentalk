      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "«Искал ключ, вдруг замок открылся, и хорошо, что батарея в телефоне была " +
              "новая» — так рассказывают о случае по-русски.",
            "Сначала говорят, что уже шло. Потом — что случилось. Потом — чем это кончилось.",
            "То, что уже шло, берёт длительное действие, а то, что случилось, — законченное.",
          ],
        },
        {
        ...
        },
        {
          ...
          kind: "table",
          caption: "Семь строк о прошлом рядом",
          zvuchat: [
            "The film was good.",
            "I worked yesterday.",
            "I went to Astana.",
          ...
          rows: [
            ...
            [
              "I was cooking when my colleague came.",
              "Я готовил, когда пришёл сослуживец.",
              "одно тянулось, другое случилось",
            ],
            ["I didn't work.", "Я не работал.", "дела не было"],
            ["Did you work?", "Ты работал?", "спросить о деле"],
        ...
        },
        {
          ...
          kind: "explain",
          text: [
            "Способов здесь четыре: сказать, что дело было, что его не было, спросить о нём и сказать, что оно шло в тот миг.",
            "Форма глагола при этом бывает двух видов — с окончанием (worked) и своя собственная (went).",
            "Это не выбор: про каждый глагол надо просто знать, какой он.",
            "Теперь посмотри на две последние строки. По-русски «В семь я работал» и «Вчера я работал» — одно и то же слово.",
            "По-английски это разные записи: was working и worked.",
          ],
        },
        {
          id: "slovar-melochey",
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "А комнаты и вещи в доме часто зовут двумя словами: living room, washing machine.",
          ],
        },
        {
          id: "tri-komnaty",
        ...
        },
        {
          ...
          explain:
            "Семь строк об одном вечере. Многие дела по дому называют парой слов: " +
            "wash up, tidy up, lie down, sit down.",
        },
        {
          id: "slovar-sborov",
          kind: "vocab",
  ...
  quiz: {
    ...
    questions: [
      ...
      },
      {
        ...
        kind: "choice",
        outcome: "понимать рассказ, где длительное действие прервано законченным",
        // Строка была дословно из сообщения для чтения того же модуля — семь слов
        // подряд. Строка новая, того же жанра, обе формы по-прежнему прошедшие.
        prompt: "В сообщении написано: «When the lesson finished, I called my mother.» Что тянулось?",
        options: [
          { text: "Конец занятия" },
