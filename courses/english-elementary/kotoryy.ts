...
const module: Module = {
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Устройство то же, что в модуле «Если»: главная часть, а к ней приставлена вторая часть.",
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Он говорит: the bag which is on the table — «та сумка, что лежит на столе».",
          ],
        },
        {
        ...
        },
        {
          ...
          text: [
            ...
            "Там, где после which сразу идёт глагол, вещь сама что-то делает.",
            "А там, где после which идёт человек, действует он: I bought, my sister gave.",
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "По-английски оно стоит вплотную: The film that I watched was long — «фильм, который я смотрел, был длинный».",
          ],
        },
        {
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          hint: "Про остановку сказано во второй части записи.",
          why:
      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "Ученик прислал снимок и подписал его: «This is my family.» — «Это моя семья.»",
  ...
  quiz: {
    ...
    questions: [
      ...
      {
        id: "q-kakaya-podpis-polnaya",
        kind: "choice",
        outcome: "проверять подпись к снимку: назван человек, дано описание и сказано, чем он важен",
        // Все три варианта дословно совпадали с заданием 1 урока 6, переставлен был
        // только верный: ученик узнавал набор кнопок. Теперь сравниваются две
        // подписи, и решать надо не «какой строки нет», а какая подпись полная.
        // Первая правка объявила полной подпись «She is tall. She teaches me
        // English.» — а список урока 6 требует описания СО СЛОВОМ who, и его там
        // не было. Для модуля «Который» это подрывало предмет. Заодно третий
        // вариант дословно повторял условие. Нашёл методист.
        prompt:
          "Две подписи к снимкам: «This is my uncle. He is tall and quiet.» и «This " +
          "is my friend Dana. She is a teacher who works at our school. She helps me " +
          "with English.» В какой из них есть все три нужные строки?",
        options: [
          { text: "В первой." },
          { text: "В обеих." },
          { text: "Во второй.", correct: true },
        ],
        hint: "Строки такие: кто это, описание со словом who, чем человек важен.",
        why:
          "Во второй. Дана названа, описание держится на слове who, и сказано, чем " +
          "она важна. В первой дядя назван, но описание идёт без who, а третьей " +
          "строки нет вовсе.",
      },
    ],
  },
