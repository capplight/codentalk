  ...
  quiz: {
    ...
    questions: [
      ...
      },
      {
        ...
        outcome: "проверять подпись к снимку: назван человек, дано описание и сказано, чем он важен",
        prompt:
          "В подписи стоит: This is my uncle. He is tall and quiet. Какой из трёх нужных строк здесь нет?",
        options: [
          { text: "Той, что называет человека." },
        ...
        why:
          "Той, что говорит, чем он важен. Дядя назван, и какой он — сказано, " +
          "а чем он важен для тебя, читатель не узнаёт.",
      },
    ],
  },
};
