    ...
    questions: [
      ...
      },
      {
        ...
        prompt:
          ...
          "is my friend Dana. She is tall. She teaches me English.» Какая из них полная?",
        options: [
          { text: "Первая: она короче и понятнее." },
          { text: "Обе: три строки есть в каждой." },
          { text: "Вторая: в ней есть все три нужные строки.", correct: true },
        ],
        hint: "Пройди по трём нужным строкам и вычёркивай найденное.",
        why:
          "Вторая. Человек назван, описан, и сказано, чем он важен. В первой дядя " +
          "назван и описан, а третьей строки нет.",
      },
    ],
  },
};
