 ...
 * дело»; грамматика: `will`, `won't`; отрицание и вопрос.
 *
 ...
 *
 * АНГЛИЙСКОГО ИМЕНИ ВРЕМЕНИ ЗДЕСЬ ПОКА НЕТ, И ЭТО ЖДЁТ РЕШЕНИЯ ВЛАДЕЛЬЦА.
 *
 ...
 * к преподавателю (CLAUDE.md, «Как править содержание»). Пока он не решил, урок
 * имени не даёт: `will` ученик видит по-английски в каждой строке. Данных о том,
 * «как принято», наши источники не содержат вовсе, и придумывать за них нельзя.
 *
