      ...
      blocks: [
        ...
        },
        {
          ...
          text: [
            ...
            "Речь при этом о том, что есть сейчас или будет потом.",
          ],
        },
        {
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "It may be in my backpack. — Может быть, он у меня в рюкзаке.",
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "I'm sure it's in the cabinet. — Я точно знаю, что он в шкафчике.",
            "Теперь сомнений нет, и вместо «может быть» звучит «точно знаю».",
      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "Данияр сказал приятелю I'm sure the bag is in the car — «я точно знаю, что сумка в машине», — и тот съездил зря.",
            "Скажи он It may be in the car — «может быть, она в машине», — приятель сначала позвонил бы.",
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Многие названия зданий составлены из двух слов: post office, bus station.",
  ...
  quiz: {
    ...
    questions: [
      ...
      },
      {
        ...
        outcome: "говорить о возможном: It might rain tomorrow",
        prompt:
          "Дана иногда приходит в шесть, но сегодня неизвестно. Какая запись верна?",
        options: [
          { text: "Dana might comes at six." },
          { text: "Dana might come at six.", correct: true },
          { text: "Dana might to come at six." },
        ],
        hint: "Посмотри, что стоит между might и самим приходом.",
        why:
          "Dana might come at six. В первой записи к глаголу приросло -s, во " +
          "второй между ними влезло лишнее to.",
      },
      {
