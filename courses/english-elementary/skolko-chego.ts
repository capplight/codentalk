  ...
  quiz: {
    ...
    questions: [
      ...
      // ---- итог 7 ----
      {
        ...
        why:
          "A few — несколько. Само по себе few значит «мало», а «несколько» — это a " +
          "few. Про сыр в той же строке сказано другим оборотом, и это не " +
          "случайность: яблоки считают поштучно, сыр нет.",
      },
      {
