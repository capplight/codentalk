      ...
      blocks: [
        {
          ...
          text: [
            ...
            "Книги он считает поштучно: одна книга, две книги.",
            "А воду не считает: он берёт не «две воды», а просто воду.",
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          kind: "explain",
          text: [
            "Вопрос начинается с How, а за ним сразу идёт much или many.",
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          answer: [2, 1, 0],
          hint: "Слова of между enough и вещью не бывает.",
          why:
  ...
  quiz: {
    ...
    questions: [
      ...
      // ---- итог 7 ----
      {
        ...
        outcome: "находить в сообщении, чего и сколько просят",
        prompt:
          "В сообщении строка: Take a few lemons and some sugar. Сколько просят лимонов? Ответь одним словом по-английски.",
        answer: "few",
        accept: ["Few", "a few", "несколько"],
        hint: "Количество названо оборотом, а не числом.",
        why:
          "A few — несколько. Про сахар в той же строке сказано другим оборотом, " +
          "и это не случайность: лимоны считают, сахар нет.",
      },
      {
