      ...
      blocks: [
        ...
        },
        {
          ...
          text: [
            ...
            "Слово «наречие» в курсе уже было — в модуле «Что происходило», на словах just и still.",
    ...
    // =====================================================================
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          kind: "explain",
          text: [
            "В модуле «Что происходило» наречие стояло в середине: I was just watching a film.",
  ...
  quiz: {
    ...
    questions: [
      ...
      // ---- итог 6 ----
      {
        ...
        // Карточка модуля даёт fan как «болельщик, поклонник», и ученик, ответивший
        // словом с карточки, проигрывал. Заодно условие требовало одного слова, а
        // верным стояли два. Нашли оба проверяющих.
        prompt:
          "В заметке строка: Our fans clapped loudly, and our team won easily. О ком в ней сказано loudly — о болельщиках или о команде? Ответь одним словом.",
        answer: "болельщики",
        accept: ["болельщиках", "о болельщиках", "поклонники", "поклонниках", "о поклонниках"],
        hint: "Наречие относится к тому действию, после которого стоит.",
        why:
          "О болельщиках. В строке два действия и два наречия, и каждое наречие " +
          "относится к своему.",
      },
      {
