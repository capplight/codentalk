  ...
  quiz: {
    ...
    questions: [
      ...
      // ---- итог 6 ----
      {
        ...
        prompt:
          "В заметке строка: Our fans clapped loudly, and our team won easily. О ком в ней сказано loudly — о поклонниках или о команде? Ответь одним словом.",
        answer: "о поклонниках",
        accept: ["поклонниках", "поклонники", "о поклонниках."],
        hint: "Наречие относится к тому действию, после которого стоит.",
        why:
          "О поклонниках. В строке два действия и два наречия, и каждое наречие " +
          "относится к своему.",
      },
      {
