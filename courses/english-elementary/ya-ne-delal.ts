      ...
      blocks: [
        {
          ...
          text: [
            ...
            "А расходятся они в другом — об этом урок «После didn't глагол в словарной форме».",
          ],
        },
        {
      ...
      blocks: [
        {
          ...
          text: [
            ...
            "То же с другими глаголами: I saw, но I didn't see.",
      ...
      blocks: [
        {
          ...
          kind: "explain",
          text: [
            "Алим рассказывает о вчерашнем дне, и часть дел у него не вышла.",
            "Так и бывает: что-то удалось, что-то нет, и говорят о том и о другом.",
  ...
  quiz: {
    ...
    questions: [
      ...
      // ---- итог 7 ----
      {
        ...
        kind: "short",
        outcome: "понимать письмо, где о части дел сказано, что их не было",
        // Строка была дословно взята из письма для чтения того же модуля: ученик
        // отвечал по прочитанному, а не разбирал новую строку. Строка новая, того
        // же жанра, слова — карточки этого же модуля.
        prompt:
          "В письме написано: «I waited at work all morning. The boss didn't call " +
          "and the assistant didn't answer my email.» Сколько человек подвели автора " +
          "письма? Ответь цифрой.",
        answer: "2",
        accept: ["two", "Two"],
        why:
          "Двое: начальник не позвонил, помощник не ответил. Оба дела названы с " +
          "отрицанием, и оба относятся к другим людям, а не к самому автору.",
      },
      // ---- итог 8 ----
      {
