...
export const tracks: Track[] = [
  {
    slug: "english",
    title: "Английский",
    tagline: "От первых слов до деловых переговоров",
    description:
      "Шесть уровней: разговорная речь, чтение, восприятие на слух и письмо. На каждом уровне — разбор правил простым языком, практика и итоговый экзамен с сертификатом.",
    emoji: "🇬🇧",
  ...
  },
  {
    slug: "python",
    title: "Python",
    tagline: "От первой программы до работы с данными",
    description:
      "Программирование с нуля на практических задачах. Код выполняется прямо в браузере: написали — сразу видите результат, без установки программ на компьютер.",
    emoji: "🐍",
    comingSoon: true,
    levels: [],
    syllabus: [
  ...
  },
  {
    slug: "kazakh",
    title: "Казахский",
    tagline: "Разговорный казахский для повседневных дел",
    description:
      "Язык для повседневных дел: семья, город, работа, обращение в учреждения. Сначала разговорная речь, грамматика подкладывается под неё, а не наоборот.",
    emoji: "🇰🇿",
    comingSoon: true,
    levels: [],
    syllabus: [
  ...
  },
  {
    ...
    tagline: "HTML, CSS и JavaScript на практике",
    description:
      "Вёрстка страниц и первые сценарии. Каждый модуль заканчивается работающим результатом, который можно открыть в браузере и показать.",
    emoji: "💻",
    comingSoon: true,
    levels: [],
    syllabus: [
