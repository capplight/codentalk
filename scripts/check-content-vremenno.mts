...
import modul7 from "../courses/english-beginner-2/chto-eto-takoe.ts";
for (const c of courses) if (c.slug === "english-beginner-2" && !c.modules.some((m) => m.slug === "chto-eto-takoe")) c.modules.push(modul7 as any);
