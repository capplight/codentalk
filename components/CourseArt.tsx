 ...
 * знак не повторяют.
 *
 * ПРО ФЛАГ ДЛЯ АРАБСКОГО. Одной страны у арабского нет, и выбрать флаг
 * какого-то одного государства значило бы сказать лишнее. Взят флаг арабского
 * восстания — четыре цвета, общие для арабских флагов, и ни одна страна.
 * Решение спорное, владельцу стоит его подтвердить.
 */
